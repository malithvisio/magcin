          ...
          <section className='box-section box-breadcrumb background-body'>
            <div className='container'>
              <ul className='breadcrumbs'>
                ...
                <li>
                  {' '}
                  <span className='text-breadcrumb'>Seltos K3 </span>
                </li>
              </ul>
            </div>
          </section>
                ...
                <div className='box-banner-activities'>
                  ...
                  >
                    <div className='banner-slide-activity'>
                      <img
                        src='/assets/imgs/page/car/banner2.png'
                        alt='Travila'
                      />
                    </div>
                    <div className='banner-slide-activity'>
                  ...
                  <div className='col-lg-8'>
                    <div className='tour-title-main'>
                      <h4 className='neutral-1000'>
                        Seltos K3 - Modern compact SUV in blue color on
              ...
              <div className='row mt-30'>
                      ...
                      <div className='item-feature-car'>
                        <div className='item-feature-car-inner'>
                          <div className='feature-image'>
                            {' '}
                            <img
                              src='/assets/imgs/page/car/km.png'
                              alt='Travila'
                            />
                          </div>
                      ...
                      <div className='item-feature-car'>
                        <div className='item-feature-car-inner'>
                          <div className='feature-image'>
                            {' '}
                            <img
                              src='/assets/imgs/page/car/diesel.png'
                              alt='Travila'
                            />
                          </div>
                          <div className='feature-info'>
                      ...
                      <div className='item-feature-car'>
                        <div className='item-feature-car-inner'>
                          <div className='feature-image'>
                            {' '}
                            <img
                              src='/assets/imgs/page/car/auto.png'
                              alt='Travila'
                            />
                          </div>
                          <div className='feature-info'>
                      ...
                      <div className='item-feature-car'>
                        <div className='item-feature-car-inner'>
                          <div className='feature-image'>
                            {' '}
                            <img
                              src='/assets/imgs/page/car/seat.png'
                              alt='Travila'
                            />
                          </div>
                          <div className='feature-info'>
                      ...
                      <div className='item-feature-car'>
                        <div className='item-feature-car-inner'>
                          <div className='feature-image'>
                            {' '}
                            <img
                              src='/assets/imgs/page/car/bag.png'
                              alt='Travila'
                            />
                          </div>
                          <div className='feature-info'>
                      ...
                      <div className='item-feature-car'>
                        <div className='item-feature-car-inner'>
                          <div className='feature-image'>
                            {' '}
                            <img
                              src='/assets/imgs/page/car/suv.png'
                              alt='Travila'
                            />
                          </div>
                          <div className='feature-info'>
                      ...
                      <div className='item-feature-car'>
                        <div className='item-feature-car-inner'>
                          <div className='feature-image'>
                            {' '}
                            <img
                              src='/assets/imgs/page/car/door.png'
                              alt='Travila'
                            />
                          </div>
                          <div className='feature-info'>
                      ...
                      <div className='item-feature-car'>
                        <div className='item-feature-car-inner'>
                          <div className='feature-image'>
                            {' '}
                            <img
                              src='/assets/imgs/page/car/lit.png'
                              alt='Travila'
                            />
                          </div>
                          <div className='feature-info'>
                ...
                <div className='col-lg-4'>
                  ...
                  <div className='sidebar-banner'>
                    ...
                    <Link href='#'>
                      <img
                        src='/assets/imgs/page/car/banner-ads.png'
                        alt='Travila'
                      />
                    </Link>
                  </div>
            ...
            <div className='container'>
              <div className='row'>
                <div className='col-lg-6'>
                  ...
                  <div className='box-image-how wow fadeInUp'>
                    {' '}
                    <img
                      src='/assets/imgs/page/homepage8/img-how.png'
                      alt='Travila'
                    />
                    <span className='img-arrow'>
                      {' '}
                      <img
                        src='/assets/imgs/page/homepage8/img-arrow.png'
                        alt='Travila'
                      />
                    </span>
                    <span className='img-dot'>
                      {' '}
                      <img
                        src='/assets/imgs/page/homepage8/dot-img.png'
                        alt='Travila'
                      />
                    </span>
                  </div>
                    ...
                    <li>
                      ...
                      <div className='step-info'>
                        ...
                        <p className='text-sm-medium neutral-500'>
                          ...
                          optional services like delivery, and excellent
                          customer support.
                        </p>
                      </div>
                    </li>
                  ...
                  <div className='col-xl-3 col-lg-4 col-md-6 wow fadeInDown'>
                    <div className='card-spot background-card'>
                      <div className='card-image'>
                        ...
                        <Link href='#'>
                          <img
                            src='/assets/imgs/page/homepage8/service.png'
                            alt='Travila'
                          />
                        </Link>
                      </div>
                      <div className='card-info background-card'>
                        <div className='card-left'>
                          ...
                          <div className='card-desc'>
                            {' '}
                            <Link className='text-sm neutral-500' href='#'>
                              17 services
                            </Link>
                          </div>
                        </div>
                  ...
                  <div className='col-xl-3 col-lg-4 col-md-6 wow fadeInDown'>
                    <div className='card-spot background-card'>
                      <div className='card-image'>
                        ...
                        <Link href='#'>
                          <img
                            src='/assets/imgs/page/homepage8/service2.png'
                            alt='Travila'
                          />
                        </Link>
                      </div>
                  ...
                  <div className='col-xl-3 col-lg-4 col-md-6 wow fadeInDown'>
                    <div className='card-spot background-card'>
                      <div className='card-image'>
                        ...
                        <Link href='#'>
                          <img
                            src='/assets/imgs/page/homepage8/service3.png'
                            alt='Travila'
                          />
                        </Link>
                      </div>
                  ...
                  <div className='col-xl-3 col-lg-4 col-md-6 wow fadeInDown'>
                    <div className='card-spot background-card'>
                      <div className='card-image'>
                        ...
                        <Link href='#'>
                          <img
                            src='/assets/imgs/page/homepage8/service4.png'
                            alt='Travila'
                          />
                        </Link>
                      </div>
