          ...
          <section className='box-section box-breadcrumb background-body'>
            <div className='container'>
              <ul className='breadcrumbs'>
                ...
                <li>
                  {' '}
                  <Link href='/destination-4'>Destinations</Link>
                  <span className='arrow-right'>
                    <svg
                      width={7}
                      height={12}
                ...
                <li>
                  {' '}
                  <Link href='/destination-4'>Europe</Link>
                  <span className='arrow-right'>
                    <svg
                      width={7}
                      height={12}
                ...
                <li>
                  {' '}
                  <span className='text-breadcrumb'>Paris</span>
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className='container'>
              <div className='row align-items-center'>
                <div className='col-lg-7 mb-30'>
                  <div className='box-left-payment-destination'>
                    ...
                    <p className='text-xl-medium neutral-500 mb-35'>
                      Explore iconic landmarks and timeless beauty in the City
                      of Light.
                    </p>
                    <div className='box-button-faq wow fadeInRight'>
                      ...
                      <Link className='btn btn-border-1' href='#'>
                        ...
                        >
                          <path
                            d='M23.2799 22.5938H20.801V6.32812C20.801 5.93981 20.4862 5.625 20.0979 5.625H17.6538V3.51562C17.6538 3.12731 17.339 2.8125 16.9507 2.8125H15.5842V0.703125C15.5842 0.314812 15.2694 0 14.881 0H9.11898C8.73067 0 8.41586 0.314812 8.41586 0.703125V2.8125H7.04931C6.661 2.8125 6.34618 3.12731 6.34618 3.51562V5.625H3.90217C3.51386 5.625 3.19904 5.93981 3.19904 6.32812V22.5938H0.720154C0.331841 22.5938 0.0170288 22.9086 0.0170288 23.2969C0.0170288 23.6852 0.331841 24 0.720154 24H23.2798C23.6681 24 23.983 23.6852 23.983 23.2969C23.983 22.9086 23.6682 22.5938 23.2799 22.5938ZM9.82211 1.40625H14.1779V2.8125H9.82211V1.40625ZM7.75243 4.21875H16.2476V5.625H7.75243V4.21875ZM11.2969 22.5938H8.48439V18.3871H11.2969V22.5938ZM15.5156 22.5938H12.7031V18.3871H15.5156V22.5938ZM19.3947 22.5938H16.9219V17.684C16.9219 17.2957 16.6071 16.9809 16.2188 16.9809H7.78126C7.39295 16.9809 7.07814 17.2957 7.07814 17.684V22.5938H4.60529V7.03125H19.3947V22.5938Z'
                            fill='#737373'
                          />
                          <path
                            d='M16.2188 15.2226C16.6071 15.2226 16.9219 14.9078 16.9219 14.5195V13.5C16.9219 13.1117 16.6071 12.7969 16.2188 12.7969C15.8304 12.7969 15.5156 13.1117 15.5156 13.5V14.5195C15.5156 14.9078 15.8304 15.2226 16.2188 15.2226Z'
                            fill='#737373'
                          />
                          <path
                            d='M13.4062 15.2226C13.7946 15.2226 14.1094 14.9078 14.1094 14.5195V13.5C14.1094 13.1117 13.7946 12.7969 13.4062 12.7969C13.0179 12.7969 12.7031 13.1117 12.7031 13.5V14.5195C12.7031 14.9078 13.0179 15.2226 13.4062 15.2226Z'
                            fill='#737373'
                          />
                          <path
                            d='M10.5938 15.2226C10.9821 15.2226 11.2969 14.9078 11.2969 14.5195V13.5C11.2969 13.1117 10.9821 12.7969 10.5938 12.7969C10.2054 12.7969 9.89062 13.1117 9.89062 13.5V14.5195C9.89062 14.9078 10.2054 15.2226 10.5938 15.2226Z'
                            fill='#737373'
                          />
                          <path
                            d='M7.78125 15.2226C8.16956 15.2226 8.48438 14.9078 8.48438 14.5195V13.5C8.48438 13.1117 8.16956 12.7969 7.78125 12.7969C7.39294 12.7969 7.07812 13.1117 7.07812 13.5V14.5195C7.07812 14.9078 7.39294 15.2226 7.78125 15.2226Z'
                            fill='#737373'
                          />
                          <path
                            d='M16.2188 11.4726C16.6071 11.4726 16.9219 11.1578 16.9219 10.7695V9.75C16.9219 9.36169 16.6071 9.04688 16.2188 9.04688C15.8304 9.04688 15.5156 9.36169 15.5156 9.75V10.7695C15.5156 11.1578 15.8304 11.4726 16.2188 11.4726Z'
                            fill='#737373'
                          />
                          <path
                            d='M13.4062 11.4726C13.7946 11.4726 14.1094 11.1578 14.1094 10.7695V9.75C14.1094 9.36169 13.7946 9.04688 13.4062 9.04688C13.0179 9.04688 12.7031 9.36169 12.7031 9.75V10.7695C12.7031 11.1578 13.0179 11.4726 13.4062 11.4726Z'
                            fill='#737373'
                          />
                          <path
                            d='M10.5938 11.4726C10.9821 11.4726 11.2969 11.1578 11.2969 10.7695V9.75C11.2969 9.36169 10.9821 9.04688 10.5938 9.04688C10.2054 9.04688 9.89062 9.36169 9.89062 9.75V10.7695C9.89062 11.1578 10.2054 11.4726 10.5938 11.4726Z'
                            fill='#737373'
                          />
                          <path
                            d='M7.78125 11.4726C8.16956 11.4726 8.48438 11.1578 8.48438 10.7695V9.75C8.48438 9.36169 8.16956 9.04688 7.78125 9.04688C7.39294 9.04688 7.07812 9.36169 7.07812 9.75V10.7695C7.07812 11.1578 7.39294 11.4726 7.78125 11.4726Z'
                            fill='#737373'
                          />
                        </svg>
                        Property
                    ...
                    <div className='row align-items-center'>
                      <div className='col-4 mb-30'>
                        <img
                          ...
                          src='/assets/imgs/page/destination/paris.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='col-4 mb-30'>
                        <img
                          ...
                          src='/assets/imgs/page/destination/paris2.png'
                          alt='Travila'
                        />
                        <img
                          className='bdrd8 w-100'
                          src='/assets/imgs/page/destination/paris3.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='col-4 mb-30'>
                        <img
                          className='bdrd8 w-100 mb-15'
                          src='/assets/imgs/page/destination/paris4.png'
                          alt='Travila'
                        />
                        <img
                          className='bdrd8 w-100'
                          src='/assets/imgs/page/destination/paris5.png'
                          alt='Travila'
                        />
                      </div>
                    </div>
            ...
            <div className='container'>
              <div className='row'>
                  ...
                  <div className='row'>
                    <div className='col-6'>
                      <div className='box-welcome-image-1'>
                        {' '}
                        <img
                          src='/assets/imgs/page/destination/welcome.png'
                          alt='Travile'
                        />
                        <img
                          src='/assets/imgs/page/destination/welcome2.png'
                          alt='Travile'
                        />
                      </div>
                    </div>
                    <div className='col-6'>
                      <div className='box-welcome-image-2'>
                        {' '}
                        <img
                          src='/assets/imgs/page/destination/welcome3.png'
                          alt='Travile'
                        />
                        <img
                          src='/assets/imgs/page/destination/welcome4.png'
                          alt='Travile'
                        />
                      </div>
                    </div>
                ...
                <div className='col-lg-7'>
                  ...
                  <p className='text-xl-medium neutral-1000 mt-55 mb-45'>
                    Paris, the City of Light, effortlessly blends its rich
                    history with contemporary flair, offering a captivating
                    tapestry of experiences for every visitor. Its iconic
                    monument-lined boulevards, adorned with architectural
                    marvels like the Eiffel Tower and Notre-Dame Cathedral,
                    stand as timeless symbols of beauty and grandeur. Amidst
                    this classical backdrop, Paris pulsates with modern energy,
                    fueled by a dynamic blend of culture, cuisine, and
                    innovation.
                  </p>
                  <div className='box-buttons d-flex align-items-center'>
                    {' '}
                    <Link className='btn btn-black-lg mr-10' href='#'>
                      Best Time To Visit
                      <svg
                        width={16}
                        height={16}
                      ...
                      <div className='card-info'>
                        ...
                        <div className='card-meta'>
                          <div className='meta-links'>
                            {' '}
                            <Link className='text-tour' href='/destination'>
                              356 Tours
                            </Link>
                          </div>
              ...
              <div className='row align-items-center'>
                <div className='col-lg-6 mb-30'>
                  ...
                  <p className='text-xl-medium neutral-1000 mb-30 wow fadeInUp'>
                    Paris is known around the world as the “capital of love,”
                    and even if you don't understand the history of Paris at all
                  </p>
                  <div className='row'>
                    <div className='col-sm-6 mb-15'>
                      {' '}
                      <span className='text-xl-medium neutral-1000'>
                    ...
                    <div className='col-sm-6 mb-15'>
                      {' '}
                      <span className='text-xl-medium neutral-1000'>
                        Peak Season: <strong>June - October</strong>
                      </span>
                    </div>
                    <div className='col-sm-6 mb-15'>
                      {' '}
                      <span className='text-xl-medium neutral-1000'>
                        Time Zone: <strong>UTC +1</strong>
                      </span>
                    </div>
                    <div className='col-sm-6 mb-15'>
                      {' '}
                      <span className='text-xl-medium neutral-1000'>
                        Currency: <strong>Euros</strong>
                      </span>
                    </div>
                  </div>
                </div>
