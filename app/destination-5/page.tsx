            ...
            <div className='box-banner-2-col'>
              ...
              <div className='banner-destination-right'>
                <div className='map-main'>
                  <iframe
                    src='https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d81636.79503321911!2d2.260428085099423!3d48.84096555752387!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66e1f06e2b70f%3A0x40b82c3688c9460!2zUGEgcmksIFBow6Fw!5e0!3m2!1svi!2s!4v1709140303534!5m2!1svi!2s'
                    width='100%'
                    height='100%'
                    style={{ border: 0 }}
                    allowFullScreen
            ...
            <div className='container'>
              <div className='row'>
                <div className='col-lg-7'>
                  ...
                  <div className='box-buttons d-flex align-items-center flex-wrap'>
                    {' '}
                    <Link className='btn btn-black-lg mr-10 mb-15' href='#'>
                      Best Time To Visit
                      <svg
                        width={16}
                        height={16}
                    ...
                    <Link className='btn btn-brand-secondary mb-15' href='#'>
                      Trending Tours
                      <svg
                        width={16}
                        height={16}
