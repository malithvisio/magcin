                    ...
                    <div className='card-info'>
                      <div className='card-title'>
                        ...
                        <p className='text-xs-medium neutral-500'>
                          Communicate your problems with the community
                        </p>
                      </div>
                  ...
                  <div className='card-contact'>
                    <div className='card-image'>
                      <div className='card-icon'>
                        ...
                        >
                          ...
                          <path
                            d='M5.76752 10.5H5.80502L6.75002 10.4512C6.94893 10.4408 7.13555 10.3518 7.26882 10.2037C7.40209 10.0557 7.47109 9.86077 7.46065 9.66185C7.4502 9.46294 7.36117 9.27632 7.21313 9.14306C7.0651 9.00979 6.87018 8.94079 6.67127 8.95123L5.73002 8.99998C5.53111 9.00495 5.34232 9.08874 5.20518 9.23291C5.06805 9.37708 4.9938 9.56982 4.99877 9.76873C5.00374 9.96764 5.08753 10.1564 5.2317 10.2936C5.37587 10.4307 5.56861 10.505 5.76752 10.5Z'
                            fill='black'
                          />
                        </svg>
                      </div>
                    ...
                    <div className='card-info'>
                      <div className='card-title'>
                        ...
                        <p className='text-xs-medium neutral-500'>
                          Dive in to learn all about Travila Platform
                        </p>
                      </div>
                      <div className='card-method-contact'>
                        {' '}
          ...
          <section className='section-box box-news box-news-2 background-9'>
            ...
            <div className='container-slider box-swiper-padding'>
              <div className='box-list-news'>
                ...
                <div className='mt-40'>
                  <Link className='btn btn-black-lg' href='/blog-detail'>
                    View More
                    <svg
                      width={16}
                      height={16}
