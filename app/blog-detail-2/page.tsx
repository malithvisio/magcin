            ...
            <div className='container'>
              <div className='box-banner-single-blog'>
                <div className='box-button-top-right'>
                  {' '}
                  <Link className='btn btn-label-tag-lg background-2' href='#'>
                    Wanderlust
                  </Link>
                  <Link className='btn btn-label-tag-lg background-7' href='#'>
                    Adventure
                  </Link>
                </div>
                  ...
                  <div className='box-content-detail-blog'>
                    <div className='box-content-info-detail mt-0 pt-0'>
                      ...
                      <div className='box-image-video'>
                        ...
                        <img
                          className='bdrd8'
                          src='/assets/imgs/page/blog/banner-detail3.png'
                          alt='Travilla'
                        />
                      ...
                      <div className='content-detail-post'>
                        ...
                        <h6>
                          1. Embracing Serenity in the Scottish Highlands:
                        </h6>
                        <p>
                          ...
                          fairytale. Far from the hustle and bustle of city
                          life, we'll wander along winding trails, breathing in
                          the crisp Highland air and immersing ourselves in the
                          tranquility of nature. From the ancient ruins of
                          castles to the timeless charm of quaint villages,
                          every corner of this enchanting region holds the
                          promise of adventure.
                        </p>
                        <h6>
                          2. Chasing Waterfalls in the Heart of Costa Rica:
                        </h6>
                        <p>
                        ...
                        <h6>
                          3. Uncovering Ancient Mysteries in the Temples of
                          Myanmar:
                        </h6>
                        <p>
