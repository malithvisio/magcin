                  ...
                  <div className='col-lg-8'>
                    <div className='tour-title-main'>
                      <h4 className='neutral-1000'>
                        The High Roller Experience: Tickets for The LINQ
                        Observation Wheel, Las Vegas Strip
                      </h4>
                    </div>
                  </div>
                </div>
            ...
            <div className='container position-relative'>
              ...
              <div className='banne-activities-3'>
                <div className='banner-col-1'>
                  {' '}
                  <img
                    src='/assets/imgs/page/activities/banner2.png'
                    alt='Travila'
                  />
                </div>
                <div className='banner-col-2'>
                  {' '}
                  <img
                    src='/assets/imgs/page/activities/banner3.png'
                    alt='Travila'
                  />
                </div>
                <div className='banner-col-3'>
                  {' '}
                  <img
                    src='/assets/imgs/page/activities/banner4.png'
                    alt='Travila'
                  />
                </div>
              </div>
                  ...
                  <div className='box-collapse-expand'>
                    ...
                    <div className='group-collapse-expand'>
                      ...
                      >
                        <div className='card card-body'>
                          <p>
                            This itinerary provides a balanced mix of outdoor
                            activities, exploration, relaxation, and cultural
                            experiences, making the most of the time available
                            for travelers to immerse themselves in the beauty
                            and charm of Discovery Mountain. Adjustments can be
                            made based on specific interests, group preferences,
                            ...
                            <div className='item-question'>
                              ...
                              <div className='content-question'>
                                <div className='text-sm-medium neutral-800'>
                                  <ul>
                                    <li>
                                      Morning: Arrival at Discovery Mountain.
                                      Check-in at the accommodation.
                                    </li>
                                    <li>
                                      Afternoon: Orientation session, including
                                      safety briefings and an overview of the
                                      itinerary.
                                    </li>
                                    <li>
                                      Evening: Welcome dinner and relaxation.
                                    </li>
                                  </ul>
                                </div>
                              </div>
                            ...
                            <div className='item-question active'>
                              ...
                              <div className='content-question'>
                                <div className='text-sm-medium neutral-800'>
                                  <ul>
                                    <li>
                                      Morning: Guided hike through the valleys
                                      of Discovery Mountain, learning about the
                                      flora and fauna.
                                    </li>
                                    <li>
                                      Afternoon: Picnic lunch in a scenic spot
                                      followed by leisure time for photography
                                      or further exploration.
                                    </li>
                                    <li>
                                      Evening: Group dinner and optional
                                      stargazing session.
                                    </li>
                                  </ul>
                                </div>
                            ...
                            <div className='item-question'>
                              ...
                              <div className='content-question'>
                                <div className='text-sm-medium neutral-800'>
                                  <ul>
                                    <li>
                                      Morning: Early start for a challenging
                                      trek to the summit of Discovery Mountain,
                                      with breathtaking views.
                                    </li>
                                    <li>
                                      Afternoon: Summit picnic lunch and time to
                                      savor the accomplishment and scenery.
                                    </li>
                                    <li>
                                      Evening: Return to base camp, rest, and
                                      relaxation.
                                    </li>
                                  </ul>
                                </div>
                            ...
                            <div className='item-question'>
                              ...
                              <div className='content-question'>
                                <div className='text-sm-medium neutral-800'>
                                  <ul>
                                    <li>
                                      Morning: Excursion to discover the hidden
                                      waterfalls of Discovery Mountain, with
                                      opportunities for swimming and
                                      photography.
                                    </li>
                                    <li>
                                      Afternoon: Lunch by the waterfall followed
                                      by a visit to a local cultural site or
                                      community interaction activity.
                                    </li>
                                    <li>
                                      Evening: Farewell dinner with local
                                      specialties and traditional entertainment.
                                    </li>
                                  </ul>
                                </div>
                              </div>
                            ...
                            <div className='item-question'>
                              ...
                              <div className='content-question'>
                                <div className='text-sm-medium neutral-800'>
                                  <ul>
                                    <li>
                                      Morning: Optional activities such as bird
                                      watching or a final hike.
                                    </li>
                                    <li>
                                      Afternoon: Check-out from accommodation
                                      and departure from Discovery Mountain.
                                    </li>
                                  </ul>
                                </div>
                              </div>
                        ...
                        <div className='card card-body'>
                          <div className='row'>
                            <div className='col-lg-6'>
                              ...
                              <ul>
                                <li>
                                  Admission ticket to The High Roller at The
                                  LINQ.
                                </li>
                                <li>Access to climate-controlled cabins.</li>
                                <li>
                                  Audio commentary offering insights into Las
                                  Vegas history and landmarks.
                                </li>
                              </ul>
                            </div>
                            <div className='col-lg-6'>
