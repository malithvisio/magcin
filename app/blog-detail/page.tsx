        ...
        <main className='main'>
          <section className='box-section box-breadcrumb background-body'>
            <div className='container'>
              <ul className='breadcrumbs'>
                ...
                <li>
                  {' '}
                  <Link href='/destination'>Blog</Link>
                  <span className='arrow-right'>
                    <svg
                      width={7}
                      height={12}
          ...
          <section className='box-section box-content-blog-detail background-body'>
            <div className='container-banner-blog-detail'>
              {' '}
              <img
                src='/assets/imgs/page/blog/banner-detail.png'
                alt='Travila'
              />
            </div>
            <div className='container'>
                ...
                <div className='box-content-info-detail'>
                  <div className='head-blog-detail text-center'>
                    ...
                    <h4 className='neutral-1000 mt-25 mb-25'>
                      Wanderlust Chronicles: Unveiling Hidden Havens and
                      Forgotten Pathways
                    </h4>
                  ...
                  <div className='content-detail-post'>
                    <p className='neutral-1000'>
                      In a world filled with wonders waiting to be discovered,
                      the allure of the road less traveled beckons to the
                      adventurous soul. Join me on a journey beyond the beaten
                      path, where each destination promises unique experiences
                      and unforgettable memories. From hidden paradises to
                      cultural gems, let's embark on an odyssey of exploration
                      and discovery.
                    </p>
                  </div>
                  ...
                  <div className='content-detail-post'>
                    ...
                    <p>
                      Our adventure begins amidst the rugged beauty of the
                      Scottish Highlands, where mist-covered mountains and
                      shimmering lochs create a landscape straight out of a
                      fairytale. Far from the hustle and bustle of city life,
                      we'll wander along winding trails, breathing in the crisp
                      Highland air and immersing ourselves in the tranquility of
                      nature. From the ancient ruins of castles to the timeless
                      charm of quaint villages, every corner of this enchanting
                      region holds the promise of adventure.
                    </p>
                    <h6>2. Chasing Waterfalls in the Heart of Costa Rica:</h6>
                    <p>
                      Next, we'll journey to the lush rainforests of Costa Rica,
                      a land of unparalleled biodiversity and natural splendor.
                      Here, hidden within the emerald green canopy, lie some of
                      the world's most breathtaking waterfalls. We'll trek
                      through dense jungle trails, listening to the symphony of
                      exotic birdsong and the gentle rush of cascading water as
                      we discover hidden oases tucked away from the beaten path.
                      With each plunge into crystal-clear pools beneath
                      thundering falls, we'll find renewal and connection with
                      the raw power of nature.
                    </p>
                    <h6>
                      3. Uncovering Ancient Mysteries in the Temples of Myanmar:
                    </h6>
                    <p>
                      Our quest for adventure takes us to the enchanting land of
                      Myanmar, where ancient temples and pagodas whisper tales
                      of bygone eras. From the sprawling plains of Bagan to the
                      serene shores of Inle Lake, we'll journey through a
                      landscape steeped in spirituality and tradition. Amidst
                      the golden spires and intricate carvings of centuries-old
                      monuments, we'll uncover the timeless beauty of Burmese
                      culture and the enduring legacy of a land shrouded in
                      mystery.
                    </p>
                    <h6>
                      4. Sailing into the Unknown in the Galápagos Islands:
                    </h6>
                    <p>
                      Our voyage of discovery leads us to the remote shores of
                      the Galápagos Islands, a haven of biodiversity teeming
                      with life found nowhere else on Earth. Setting sail on
                      azure waters, we'll explore pristine beaches, volcanic
                      landscapes, and bustling seabird colonies. Snorkeling
                      alongside graceful sea turtles and playful sea lions,
                      we'll witness the delicate balance of life in one of the
                      world's most pristine marine ecosystems, leaving us
                      humbled by the wonders of the natural world.
                    </p>
                    <h6>
                      5. Lost in Time: Exploring the Medieval Villages of
                      Transylvania, Romania:
                    </h6>
                    <p>
                      Our final destination transports us to the storied land of
                      Transylvania, where medieval castles and fortified
                      churches dot the landscape like something out of a Gothic
                      fairy tale. Venturing off the beaten path, we'll wander
                      through cobblestone streets and labyrinthine alleyways,
                      immersing ourselves in the rich history and folklore of
                      this captivating region. From the haunting beauty of Bran
                      Castle to the picturesque charm of Sighisoara, every
                      corner of Transylvania holds a story waiting to be
                      discovered.
                    </p>
                        ...
                        <div className='item-review'>
                          ...
                          <div className='content-review'>
                            <p className='text-sm-medium neutral-800'>
                              ...
                              stunning! It's a fantastic way to see the Strip
                              and the surrounding area. The cabins are spacious
                              and comfortable, and the audio commentary adds an
                              extra layer of enjoyment. Highly recommend!
                            </p>
                          </div>
                        </div>
                        <div className='item-review'>
