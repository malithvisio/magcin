          ...
          <section className='box-section box-breadcrumb background-100'>
            <div className='container'>
              <ul className='breadcrumbs'>
                ...
                <li>
                  {' '}
                  <span className='text-breadcrumb'>Contact</span>
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className='container'>
              <div className='text-center'>
                ...
                <p className='text-xl-medium neutral-1000 mb-55 wow fadeInUp'>
                  Anywhere you choose, you have the potential to become a Local
                  Expert in anything
                </p>
              </div>
              <div className='box-image-video mb-0'>
                ...
                <img
                  className='bdrd-16'
                  src='/assets/imgs/page/pages/banner2.png'
                  alt='Travilla'
                />
                  ...
                  <div className='col-lg-3 col-md-6'>
                    <div className='card-why-travel card-business background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/pages/earth.png'
                          alt='Travila'
                        />
                      </div>
                  ...
                  <div className='col-lg-3 col-md-6'>
                    <div className='card-why-travel card-business background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/pages/tour.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <div className='col-lg-3 col-md-6'>
                    <div className='card-why-travel card-business background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/pages/custom.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <div className='col-lg-3 col-md-6'>
                    <div className='card-why-travel card-business background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/pages/car.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <div className='col-lg-3 col-md-6'>
                    <div className='card-why-travel card-business background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/pages/local.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <div className='col-lg-3 col-md-6'>
                    <div className='card-why-travel card-business background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/pages/themed.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <div className='col-lg-3 col-md-6'>
                    <div className='card-why-travel card-business background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/pages/ride.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <div className='col-lg-3 col-md-6'>
                    <div className='card-why-travel card-business background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/pages/visas.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
            ...
            <div className='container'>
              <div className='text-center'>
                <h2 className='neutral-1000'>
                  {' '}
                  <span>Why Should You </span>Choose Us?
                </h2>
                <p className='text-xl-medium neutral-500'>
              ...
              <div className='block-install-apps'>
                <div className='row align-items-center'>
                  ...
                  <div className='col-lg-6 mb-40 text-end wow fadeInRight'>
                    <div className='box-images-apps'>
                      {' '}
                      <img
                        className='img-phone'
                        src='/assets/imgs/page/homepage4/phone.png'
                        alt='Travila'
                      />
                      <img
                      ...
                      <div className='shape'>
                        ...
                        <img
                          ...
                          src='/assets/imgs/page/homepage4/arrow-big.png'
                          alt='Travila'
                        />
                        <img
                          src='/assets/imgs/page/homepage4/arrow-sm.png'
                          alt='Travila'
                        />
                      </div>
                    </div>
