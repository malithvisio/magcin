...
import HotelCard3 from '@/components/elements/hotelcard/HotelCard3';
        ...
        <main className='main'>
          ...
          <section className='box-section block-content-hotel background-body'>
            <div className='container'>
              ...
              <div className='box-content-main box-content-main-hotel'>
                <div className='box-grid-tours wow fadeIn'>
                  <div className='row'>
                    {paginatedHotels.map(hotel => (
                      <div className='col-xl-6 col-lg-6' key={hotel.id}>
                        <HotelCard3 hotel={hotel} />
                      </div>
                    ))}
                  </div>
                  <ByPagination
          ...
          <section className='section-box box-popular-destinations background-body pb-90'>
            <div className='container'>
              <div className='text-center'>
                <h4 className='neutral-1000 wow fadeInUp'>
                  Hotel by Attractions
                </h4>
