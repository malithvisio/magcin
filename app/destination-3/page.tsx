          ...
          <section className='box-section box-breadcrumb background-body'>
            <div className='container'>
              <ul className='breadcrumbs'>
                ...
                <li>
                  {' '}
                  <Link href='/destination-2'>Destinations</Link>
                  <span className='arrow-right'>
                    <svg
                      width={7}
                      height={12}
                ...
                <li>
                  {' '}
                  <span className='text-breadcrumb'>Europe</span>
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className='container'>
              <div className='row'>
                <div className='col-md-8'>
                  <Link className='image-gallery' href='#'>
                    <img
                      className='mb-20'
                      src='/assets/imgs/page/destination/banner3.png'
                      alt='Travile'
                    />
                  </Link>
                </div>
                  ...
                  <div className='row'>
                    <div className='col-md-12 col-6'>
                      <Link className='image-gallery' href='#'>
                        <img
                          className='mb-20'
                          src='/assets/imgs/page/destination/banner4.png'
                          alt='Travile'
                        />
                      </Link>
                    </div>
                    <div className='col-md-12 col-6'>
                      <Link className='image-gallery' href='#'>
                        <img
                          className='mb-20'
                          src='/assets/imgs/page/destination/banner5.png'
                          alt='Travile'
                        />
                      </Link>
                    </div>
                  ...
                  <Swiper {...swiperGroupAnimate}>
                    <SwiperSlide>
                      <div className='card-journey-small background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage5/tour.png'
                            alt='Travila'
                          />
                        </div>
                    ...
                    <SwiperSlide>
                      <div className='card-journey-small background-card'>
                        <div className='card-image'>
                          {' '}
                          <Link className='label bestsale' href='#'>
                            Best Sale
                          </Link>
                          <Link className='wish' href='#'>
                            <svg
                          ...
                          <img
                            src='/assets/imgs/page/homepage5/tour2.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info background-card'>
                          ...
                          <div className='card-title'>
                            ...
                            <Link
                              ...
                              href='/activities-detail'
                            >
                              Icelandic Legends: Mystical Trails Journey
                            </Link>
                          </div>
                          <div className='card-program'>
                            <div className='card-duration-tour'>
                    ...
                    <SwiperSlide>
                      <div className='card-journey-small background-card'>
                        <div className='card-image'>
                          {' '}
                          <Link className='label saleoff' href='#'>
                            25% Off
                          </Link>
                          <Link className='wish' href='#'>
                            <svg
                          ...
                          <img
                            src='/assets/imgs/page/homepage5/tour3.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info background-card'>
                          ...
                          <div className='card-title'>
                            ...
                            <Link
                              ...
                              href='/activities-detail'
                            >
                              Napa Valley Delights: Wine Country Retreat
                            </Link>
                          </div>
                          <div className='card-program'>
                            <div className='card-duration-tour'>
                    ...
                    <SwiperSlide>
                      <div className='card-journey-small background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage5/tour4.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info background-card'>
              ...
              <div className='row align-items-center'>
                  ...
                  <div className='row'>
                    <div className='col-lg-6 col-sm-6'>
                      <div className='card-video card-video-type-2'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage6/payment.png'
                            alt='Travila'
                          />
                        </div>
                      </div>
                      <div className='card-video card-video-type-2'>
                        <div className='card-image'>
                          <img
                            src='/assets/imgs/page/homepage6/payment3.png'
                            alt='Travila'
                          />
                        </div>
                      </div>
                    ...
                    <div className='col-lg-6 col-sm-6 box-image-payment-right'>
                      <div className='card-video card-video-type-2'>
                        <div className='card-image'>
                          <img
                            src='/assets/imgs/page/homepage6/payment2.png'
                            alt='Travila'
                          />
                        </div>
                      </div>
                      <div className='card-video card-video-type-2'>
                        <div className='card-image'>
                          <img
                            src='/assets/imgs/page/homepage6/payment4.png'
                            alt='Travila'
                          />
                        </div>
                      </div>
                ...
                <div className='col-lg-6 mb-30 wow fadeInUp'>
                  <div className='box-right-payment'>
                    <span className='btn btn-tag'>Easy payment</span>
                    <h2 className='title-why mb-25 mt-10 neutral-1000'>
                      We offer tours in a range of locations
                    </h2>
                    <p className='text-xl-medium mb-25 neutral-1000'>
                    ...
                    <SwiperSlide>
                      <div className='card-journey-small background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/destination/car.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <SwiperSlide>
                      <div className='card-journey-small background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/destination/car2.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <SwiperSlide>
                      <div className='card-journey-small background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/destination/car3.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <SwiperSlide>
                      <div className='card-journey-small background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/destination/car4.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
              ...
              <div className='row align-items-center'>
                <div className='col-lg-6 mb-30 wow fadeInUp'>
                  <div className='box-image-sky'>
                    <div className='col-sky-1'>
                      <img
                        className='w-100'
                        src='/assets/imgs/page/homepage10/sky.png'
                        alt='Travila'
                      />
                      <img
                        className='w-100'
                        src='/assets/imgs/page/homepage10/sky2.png'
                        alt='Travila'
                      />
                    </div>
                    <div className='col-sky-2'>
                      <img
                        className='w-100'
                        src='/assets/imgs/page/homepage10/sky3.png'
                        alt='Travila'
                      />
                    </div>
                  </div>
                ...
                <div className='col-lg-6 mb-30 wow fadeInUp'>
                  <div className='box-right-skyward'>
                    <span className='btn btn-tag-white'>Takes You Skyward</span>
                    ...
                    <p className='text-lg-medium mb-25 neutral-1000'>
                      Experience stress-free travel planning with our website
                      where you can easily book flights, check in an make
                      changes to your itinerary with just a few clicks
                    </p>
