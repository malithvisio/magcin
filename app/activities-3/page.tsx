            ...
            <div className='container'>
              <div className='text-start'>
                ...
                <h6 className='heading-6-medium'>
                  Easily search for top tours offered by our professional
                  network
                </h6>
              </div>
                  ...
                  <div className='col-lg-3 col-sm-6'>
                    <div className='card-popular card-top-destination background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/homepage6/destination.png'
                          alt='Travila'
                        />
                      </div>
                  ...
                  <div className='col-lg-3 col-sm-6'>
                    <div className='card-popular card-top-destination background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/homepage6/destination2.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <div className='col-lg-3 col-sm-6'>
                    <div className='card-popular card-top-destination background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/homepage6/destination3.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <div className='col-lg-3 col-sm-6'>
                    <div className='card-popular card-top-destination background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/homepage6/destination4.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <div className='col-lg-3 col-sm-6'>
                    <div className='card-popular card-top-destination background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/homepage6/destination5.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <div className='col-lg-3 col-sm-6'>
                    <div className='card-popular card-top-destination background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/homepage6/destination6.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <div className='col-lg-3 col-sm-6'>
                    <div className='card-popular card-top-destination background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/homepage6/destination7.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <div className='col-lg-3 col-sm-6'>
                    <div className='card-popular card-top-destination background-card wow fadeInUp'>
                      <div className='card-image'>
                        {' '}
                        <img
                          src='/assets/imgs/page/homepage6/destination8.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <div className='sidebar-left border-1 background-brand-2'>
                    <div className='box-filters-sidebar'>
                      <div className='block-filter border-1'>
                        <h6 className='text-lg-bold item-collapse'>
                          Select Your Dates
                        </h6>
                        <div className='box-collapse scrollFilter mb-10'>
                          <div className='pt-0'>
                            ...
                            <p className='text-xs-medium text-found'>
                              32 Tours found
                            </p>
                          </div>
                        </div>
