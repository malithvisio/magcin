      ...
      <Layout headerStyle={1} footerStyle={1}>
        <main className='main'>
          <section className='box-section box-breadcrumb background-body'>
            <div className='container'>
              <ul className='breadcrumbs'>
                ...
                <li>
                  {' '}
                  <Link href='/destination'>Tickets</Link>
                  <span className='arrow-right'>
                    <svg
                      width={7}
                      height={12}
          ...
          <section className='section-box block-banner-book-tickets background-card'>
            <div className='container'>
              <div className='box-image-book'>
                {' '}
                <img
                  src='/assets/imgs/page/tickets/banner-booking.png'
                  alt='Travila'
                />
                <Link className='btn-logo' href='#'>
                  <img
                    src='/assets/imgs/page/tickets/cathay.png'
                    alt='Travila'
                  />
                </Link>
              </div>
          ...
          <section className='section-box block-content-book-tickets background-card'>
            <div className='container'>
              <h4 className='neutral-1000 mb-20'>Your trip</h4>
              <p className='text-md-medium neutral-1000'>
                Embark on a seamless journey with Cathay Pacific from New York
                (JFK) to Tokyo (NRT), with a layover in vibrant Hong Kong (HKG).
                Enjoy world-class service, comfortable seating, and delicious
                dining options onboard. Take advantage of your layover to
                explore the dynamic city of Hong Kong before continuing your
                adventure to Tokyo. With Cathay Pacific, every flight promises
                ...
                <div className='col-lg-8'>
                  <div className='box-content-tickets-detail'>
                      ...
                      <div className='item-timeline'>
                        ...
                        <div className='item-line-timeline'>
                          ...
                          <div className='location-flight'>
                            ...
                            <p className='text-sm-medium neutral-500'>
                              John F Kennedy Intl Terminal 8
                            </p>
                          </div>
                        </div>
                          ...
                          <div className='list-flight-facilities'>
                            ...
                            <li className='seating'>
                              ...
                              >
                                <path
                                  fillRule='evenodd'
                                  clipRule='evenodd'
                                  d='M2.66673 3.30005C1.83832 3.30005 1.16675 3.97161 1.16675 4.80005V11.0001C1.16675 11.8285 1.83832 12.5001 2.66673 12.5001H7.50009C8.32849 12.5001 9.00009 11.8285 9.00009 11.0001V4.80005C9.00009 3.97161 8.32849 3.30005 7.50009 3.30005H2.66673ZM0.166748 4.80005C0.166748 3.41933 1.28604 2.30005 2.66673 2.30005H7.50009C8.88081 2.30005 10.0001 3.41933 10.0001 4.80005V11.0001C10.0001 12.3808 8.88081 13.5001 7.50009 13.5001H2.66673C1.28604 13.5001 0.166748 12.3808 0.166748 11.0001V4.80005Z'
                                />
                                <path
                                  fillRule='evenodd'
                                  clipRule='evenodd'
                                  d='M4.87329 1C4.87329 0.723856 5.09717 0.5 5.37329 0.5H9.56661C10.8246 0.5 11.8333 1.53907 11.8333 2.8V8.51332C11.8333 8.78948 11.6095 9.01332 11.3333 9.01332C11.0572 9.01332 10.8333 8.78948 10.8333 8.51332V2.8C10.8333 2.07426 10.2553 1.5 9.56661 1.5H5.37329C5.09717 1.5 4.87329 1.27614 4.87329 1Z'
                                />
                                <path
                                  fillRule='evenodd'
                                  clipRule='evenodd'
                                  d='M2.55347 10.6C2.55347 10.3238 2.77735 10.1 3.05347 10.1H5.41347C5.68963 10.1 5.91347 10.3238 5.91347 10.6C5.91347 10.8761 5.68963 11.1 5.41347 11.1H3.05347C2.77735 11.1 2.55347 10.8761 2.55347 10.6Z'
                                />
                              </svg>
                              Comfortable Seating
                            </li>
                            <li className='wifi'>
                              ...
                              >
                                ...
                                <path
                                  d='M8.55792 9.74347C8.55792 10.3847 8.00587 10.9016 7.32583 10.9016C6.64579 10.9016 6.09521 10.3847 6.09521 9.74347C6.09521 9.10504 6.64579 8.58813 7.32583 8.58813C8.00587 8.58813 8.55792 9.10501 8.55792 9.74347Z'
                                  fill='black'
                                />
                    ...
                    <div className='box-stop'>
                      <div className='box-stop-left'>
                        <Link className='close-stop' href='#'>
                          <img
                            src='/assets/imgs/page/tickets/close-stop.png'
                            alt='Travila'
                          />
                        </Link>
                      </div>
                      <div className='box-stop-right'>
                        <p className='text-sm-bold neutral-1000'>
                          Stop to change planes in Hong Kong (6h 35m)
                        </p>
                        <p className='text-sm-medium neutral-1000'>
                          At this stop, you need to: Prepare transit visa if
                          required
                        </p>
                      </div>
                    </div>
