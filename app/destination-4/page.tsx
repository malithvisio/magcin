    ...
    <>
      <Layout headerStyle={1} footerStyle={1}>
        <main className='main'>
            ...
            <div className='container'>
              <div className='row'>
                <div className='col-md-6 order-lg-2'>
                  <div className='destination-banner-3 mb-20'>
                    <Link className='image-gallery' href='#'>
                      <img
                        src='/assets/imgs/page/destination/banner8.png'
                        alt='Travile'
                      />
                    </Link>
                  </div>
                  <div className='row'>
                    <div className='col-6'>
                      <div className='destination-banner-4 mb-20'>
                        <Link className='image-gallery' href='#'>
                          <img
                            src='/assets/imgs/page/destination/banner9.png'
                            alt='Travile'
                          />
                        </Link>
                      </div>
                    ...
                    <div className='col-6'>
                      <div className='destination-banner-5 mb-20'>
                        <Link className='image-gallery' href='#'>
                          <img
                            src='/assets/imgs/page/destination/banner10.png'
                            alt='Travile'
                          />
                        </Link>
                      </div>
                ...
                <div className='col-md-3 col-6 order-lg-1'>
                  <div className='destination-banner-1 mb-20'>
                    <Link className='image-gallery' href='#'>
                      <img
                        src='/assets/imgs/page/destination/banner6.png'
                        alt='Travile'
                      />
                    </Link>
                  </div>
                  <div className='destination-banner-2 mb-20'>
                    {' '}
                    <Link className='image-gallery' href='#'>
                      <img
                        src='/assets/imgs/page/destination/banner7.png'
                        alt='Travile'
                      />
                    </Link>
                  </div>
                ...
                <div className='col-md-3 col-6 order-lg-3'>
                  <div className='destination-banner-6 mb-20'>
                    <Link className='image-gallery' href='#'>
                      <img
                        src='/assets/imgs/page/destination/banner11.png'
                        alt='Travile'
                      />
                    </Link>
                  </div>
                  <div className='destination-banner-7 mb-20'>
                    {' '}
                    <Link className='image-gallery' href='#'>
                      <img
                        src='/assets/imgs/page/destination/banner12.png'
                        alt='Travile'
                      />
                    </Link>
                  </div>
          ...
          <section className='box-section box-buttons-destination background-4'>
            <div className='container-fluid'>
              <div className='box-button-faq wow fadeInRight'>
                {' '}
                <Link className='btn btn-border-1' href='/activities'>
                  <svg
                    width={25}
                    height={24}
                    viewBox='0 0 25 24'
                  ...
                  <div className='col-lg-3 col-sm-6'>
                    <div className='card-popular card-top-destination background-card wow fadeInUp'>
                      ...
                      <div className='card-info'>
                        {' '}
                        <Link className='card-title' href='/activities'>
                          Venice
                        </Link>
          ...
          <section className='section-box box-testimonials-2 box-testimonials-destination-4 background-body'>
            <div className='container'>
