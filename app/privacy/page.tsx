            ...
            <div className='container'>
              ...
              <div className='box-mw-824'>
                <div className='box-detail-info'>
                  <p>
                    At Travila, we take your privacy seriously and are committed
                  ...
                  <p>
                    ...
                    payment information, and browsing activity when you interact
                    with our website or make a reservation.
                  </p>
                  <p>
                    {' '}
                    <strong>Use of Information: </strong>We use the information
                    collected to process your bookings, provide customer
                    support, improve our services, and communicate with you
                    about promotions or updates.
                  </p>
                  <p>
                    {' '}
                    <strong>Disclosure of Information:</strong>We may share your
                    information with third-party service providers, business
                    partners, or affiliates for purposes such as payment
                    processing, customer service, or marketing activities.
                  </p>
                  <p>
                    {' '}
                    <strong>Data Security: </strong>We implement security
                  ...
                  <p>
                    {' '}
                    <strong>Changes to Privacy Policy: </strong>We reserve the
                    right to update or modify this Privacy Policy at any time.
                    Any changes will be effective immediately upon posting on
                    our website.
                  </p>
                  <p>
                    If you have any questions or concerns about our Privacy
                    Policy or the handling of your personal information, please
                    contact us at contact@travila.com.
                  </p>
