                ...
                <div className='container-banner'>
                  ...
                  <div className='slider-thumnail'>
                    ...
                    >
                      <div className='banner-slide'>
                        <img
                          src='/assets/imgs/page/tour-detail/banner-thumb.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='banner-slide'>
                        <img
                          src='/assets/imgs/page/tour-detail/banner-thumb2.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='banner-slide'>
                        <img
                          src='/assets/imgs/page/tour-detail/banner-thumb3.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='banner-slide'>
                  ...
                  <div className='box-collapse-expand'>
                    ...
                    <div className='group-collapse-expand'>
                      ...
                      >
                        <div className='card card-body'>
                          <p>
                            Ascend to the skies aboard the world's tallest
                            observation wheel and marvel at the panoramic vistas
                            stretching as far as the eye can see. From the
                            iconic landmarks of the Strip to the majestic
                            mountains in the distance, every moment aboard The
                            High Roller promises breathtaking sights and
                            unforgettable memories.
                          </p>
                          <p>
                            All rooms at the resort come with air conditioning,
                            a seating area, a flat-screen TV with satellite
                            channels, a safety deposit box and a private
                            bathroom with a shower, free toiletries and a
                            hairdryer. At Pickalbatros Water Valley Resort -
                            Neverland Hurghada rooms are equipped with bed linen
                            and towels.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className='group-collapse-expand'>
                      ...
                      >
                        <div className='card card-body'>
                          <p>
                            Your adventure aboard The High Roller at The LINQ is
                            divided into six distinct moments, totaling 110
                            minutes of unforgettable experiences:
                          </p>
                          <ul className='list-number'>
                            ...
                            <li>
                              ...
                              <span>
                                Enjoy a gradual ascent over 15 minutes.
                              </span>
                            </li>
                            <li>
                              {' '}
                              <strong>Peak: </strong>
                              <span>
                                Marvel at the view for approximately 30 minutes.
                              </span>
                            </li>
                            <li>
                              {' '}
                            ...
                            <li>
                              ...
                              <span>
                                Enjoy the surroundings for the remaining 30
                                minutes.
                              </span>
                            </li>
                          </ul>
                          <p>
                            With each moment contributing to a seamless and
                            awe-inspiring experience, The High Roller promises
                            to be the highlight of your Las Vegas adventure.
                          </p>
                        </div>
                      </div>
                    </div>
