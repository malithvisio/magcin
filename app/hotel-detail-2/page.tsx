          ...
          <section className='box-section box-breadcrumb background-body'>
            <div className='container'>
              <ul className='breadcrumbs'>
                ...
                <li>
                  {' '}
                  <Link href='/destination'>Hotel Le Meurice</Link>
                  <span className='arrow-right'>
                    <svg
                      width={7}
                      height={12}
                ...
                <li>
                  {' '}
                  <span className='text-breadcrumb'>All Rooms</span>
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className='box-banner-hotel-detai-2-inner'>
              <div className='container'>
                ...
                <h6 className='color-white'>
                  Experience the Epitome of Parisian Luxury at Le Meurice Hotel:
                  Where Timeless Elegance and Unmatched Sophistication Await
                  Your Arrival.
                </h6>
              </div>
            </div>
                ...
                <div className='box-grid-hotels box-list-hotels-detail wow fadeIn'>
                      ...
                      <div className='card-hotel-2-col'>
                        <div className='card-program'>
                          <div className='card-tags'>
                            {' '}
                            <Link className='btn btn-tag-border' href='#'>
                              Air Dryer
                            </Link>
                            <Link className='btn btn-tag-border' href='#'>
                              Air conditioning
                  ...
                  <div className='card-flight card-hotel background-card'>
                    <div className='card-image'>
                      ...
                      <Link href='/room-detail-2'>
                        <img
                          src='/assets/imgs/page/hotel/hotelRoom2.png'
                          alt='Travila'
                        />
                      </Link>
                    </div>
                  ...
                  <div className='card-flight card-hotel background-card'>
                    <div className='card-image'>
                      ...
                      <Link href='/room-detail'>
                        <img
                          src='/assets/imgs/page/hotel/hotelRoom3.png'
                          alt='Travila'
                        />
                      </Link>
                    </div>
                  ...
                  <div className='card-flight card-hotel background-card'>
                    <div className='card-image'>
                      ...
                      <Link href='/room-detail-2'>
                        <img
                          src='/assets/imgs/page/hotel/hotelRoom4.png'
                          alt='Travila'
                        />
                      </Link>
                    </div>
                  ...
                  <div className='card-flight card-hotel background-card'>
                    <div className='card-image'>
                      ...
                      <Link href='/room-detail'>
                        <img
                          src='/assets/imgs/page/hotel/hotelRoom5.png'
                          alt='Travila'
                        />
                      </Link>
                    </div>
                ...
                <div className='row align-items-center'>
                  <div className='col-lg-6 mb-30'>
                    <div className='box-left-payment'>
                      <span className='btn btn-tag-white'>Easy payment</span>
                      ...
                      <div className='row align-items-center'>
                        ...
                        <div className='col-sm-4 mb-30'>
                          <img
                            ...
                            src='/assets/imgs/page/homepage2/payment2.png'
                            alt='Travila'
                          />
                          <img
                            className='bdrd8 w-100 mb-15'
                            src='/assets/imgs/page/homepage2/payment3.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='col-sm-4 mb-30'>
                          <img
                            className='bdrd8 w-100'
                            src='/assets/imgs/page/homepage2/payment4.png'
                            alt='Travila'
                          />
                          <img
                            className='bdrd8 w-100'
                            src='/assets/imgs/page/homepage2/payment5.png'
                            alt='Travila'
                          />
                        </div>
                      </div>
