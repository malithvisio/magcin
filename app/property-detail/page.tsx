                          ...
                          <div className='card-post'>
                            <div className='card-image'>
                              ...
                              <Link href='#'>
                                {' '}
                                <img
                                  src='/assets/imgs/page/property/feature.png'
                                  alt='Travila'
                                />
                              </Link>
                            </div>
                            <div className='card-info'>
                              {' '}
                              <Link className='text-md-bold' href='#'>
                                Himalayan Cedar Nest in Sainj Valley
                              </Link>
                          ...
                          <div className='card-post'>
                            <div className='card-image'>
                              ...
                              <Link href='#'>
                                {' '}
                                <img
                                  src='/assets/imgs/page/property/feature2.png'
                                  alt='Travila'
                                />
                              </Link>
                            </div>
                          ...
                          <div className='card-post'>
                            <div className='card-image'>
                              ...
                              <Link href='#'>
                                {' '}
                                <img
                                  src='/assets/imgs/page/property/feature3.png'
                                  alt='Travila'
                                />
                              </Link>
                            </div>
                            <div className='card-info'>
                              {' '}
                              <Link className='text-md-bold' href='#'>
                                Farmhouse with pool and restaurant
                              </Link>
                              <span className='price text-sm-bold neutral-1000'>
                                $48.25
                              </span>
                          ...
                          <div className='card-post'>
                            <div className='card-image'>
                              ...
                              <Link href='#'>
                                {' '}
                                <img
                                  src='/assets/imgs/page/property/feature4.png'
                                  alt='Travila'
                                />
                              </Link>
                            </div>
                          ...
                          <div className='card-post'>
                            <div className='card-image'>
                              ...
                              <Link href='#'>
                                {' '}
                                <img
                                  src='/assets/imgs/page/property/feature5.png'
                                  alt='Travila'
                                />
                              </Link>
                            </div>
                            <div className='card-info'>
                              {' '}
                              <Link className='text-md-bold' href='#'>
                                Exclusive cottage surrounded by silence
                              </Link>
                              <span className='price text-sm-bold neutral-1000'>
                                $48.25
                              </span>
                ...
                <div className='col-lg-4 col-md-6 wow fadeInUp'>
                  <div className='card-journey-small card-journey-small-type-3 card-journey-small-type-4 background-card'>
                    <div className='card-image'>
                      ...
                      <img
                        src='/assets/imgs/page/property/like.png'
                        alt='Travila'
                      />
                    </div>
                    <div className='card-info'>
                      ...
                      <div className='card-title'>
                        {' '}
                        <Link className='text-lg-bold neutral-1000' href='#'>
                          Deluxe Queen Room
                        </Link>
                      </div>
                ...
                <div className='col-lg-4 col-md-6 wow fadeInUp'>
                  <div className='card-journey-small card-journey-small-type-3 card-journey-small-type-4 background-card'>
                    <div className='card-image'>
                      ...
                      <img
                        src='/assets/imgs/page/property/like2.png'
                        alt='Travila'
                      />
                    </div>
                    <div className='card-info'>
                ...
                <div className='col-lg-4 col-md-6 wow fadeInUp'>
                  <div className='card-journey-small card-journey-small-type-3 card-journey-small-type-4 background-card'>
                    <div className='card-image'>
                      ...
                      <img
                        src='/assets/imgs/page/property/like3.png'
                        alt='Travila'
                      />
                    </div>
                    <div className='card-info'>
