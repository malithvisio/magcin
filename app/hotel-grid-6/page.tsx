...
import HotelCard2 from '@/components/elements/hotelcard/HotelCard2';
...
export default function HotelGrid6() {
  const {
    filter,
    sortCriteria,
    itemsPerPage,
                  ...
                  <div className='box-grid-hotels wow fadeIn'>
                    <div className='row'>
                      {paginatedHotels.map(hotel => (
                        <div className='col-xl-12 col-lg-12' key={hotel.id}>
                          <HotelCard2 hotel={hotel} />
                        </div>
                      ))}
                    </div>
                    <ByPagination
