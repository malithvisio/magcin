          ...
          <section className='box-section box-breadcrumb background-100'>
            <div className='container'>
              <ul className='breadcrumbs'>
                ...
                <li>
                  {' '}
                  <span className='text-breadcrumb'>Terms Of Service</span>
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className='container'>
              <div className='box-mw-824'>
                <div className='text-center'>
                  ...
                  <p className='text-xl-medium neutral-1000 mb-55 wow fadeInUp'>
              ...
              <div className='box-mw-824'>
                <div className='box-detail-info'>
                  <p className='neutral-1000'>
                    Welcome to Travila! Before you begin using our platform,
                    please take a moment to review the terms and conditions that
                  ...
                  <p>
                    {' '}
                    <strong>User Accounts:</strong>To use our platform, you must
                  ...
                  <p>
                    ...
                    subscription plans for our services, each with different
                    features and prices. You can select the plan that best fits
                    your needs and preferences.
                  </p>
                  <p>
                    {' '}
                    <strong>Payment:</strong>Payment for subscription plans is
                    due at the beginning of each billing cycle. We accept
                    various payment methods, including credit card and PayPal.
                  </p>
                  <p>
                    {' '}
                    <strong>Intellectual Property:</strong>All intellectual
                    property rights in our platform, including software,
                    content, and trademarks, are owned by us or our licensors.
                    You may not copy, modify, distribute, or sell any part of
                    our platform without our prior written consent.
                  </p>
                  <p>
                    {' '}
                    <strong>Limitation of Liability:</strong>We will not be
                    liable for any damages arising out of or in connection with
                    the use of our platform, including but not limited to
                    direct, indirect, incidental, or consequential damages.
                  </p>
                  <p>
                    {' '}
                    <strong>Termination:</strong>We reserve the right to
                    terminate or suspend your access to our platform at any
                    time, without prior notice, if you violate these terms and
                    conditions or engage in any unlawful or unauthorized
                    activity.
                  </p>
                  <p>
                    {' '}
                    <strong>Changes to Terms:</strong>We may update or modify
                  ...
                  <p>
                    ...
                    of this Privacy Policy. Please review this policy
                    periodically for updates or changes.
                  </p>
                </div>
