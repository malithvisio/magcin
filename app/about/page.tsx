    ...
    <>
      <Layout headerStyle={1} footerStyle={2}>
        <div>
                ...
                <div className='col-lg-5'>
                  <div className='box-icon-flight'>
                    ...
                    <h6 className='neutral-1000'>
                      Choose Magcin Tours for reliable, 24/7 transportation
          ...
          <Team />
          <section
            className='section-box box-why-book-travila-5'
            style={{
              background:
            ...
            <div className='container'>
              <div className='row align-items-center'>
                <div className='col-lg-6 mb-30'>
                  ...
                  <h2 className='mt-15 mb-15 text-white wow fadeInUp'>
                    Embracing Travels Since
                  </h2>
                  <h2 className='mt-15 mb-15 text-white wow fadeInUp'>2020</h2>
                  <p className='text-xl-medium text-white mb-30 wow fadeInUp'>
                  ...
                  <div className='list-numbers wow fadeInUp'>
                    ...
                    <div className='item-number'>
                      ...
                      <p className='text-lg-bold text-white'>Tours Completed</p>
                    </div>
                    <div className='item-number'>
                    ...
                    <div className='item-number'>
                      <h3 className='text-white'>1000+</h3>
                      <p className='text-lg-bold text-white'>Happy Customers</p>
                    </div>
                  </div>
                </div>
                <div className='col-lg-6 mb-30'>
                    ...
                    <div className='col-lg-6 col-sm-6 pt-30'>
                      <div className='card-why card-why-2 background-1 wow fadeInUp'>
                        ...
                        <div className='card-info'>
                          <h6 className='text-xl-bold text-white'>
                            1000+ Destinations
                          </h6>
