                        ...
                        <SwiperSlide>
                          <div className='card-popular-destination card-popular-destination-type-2'>
                            <div className='card-image'>
                              {' '}
                              <img
                                src='/assets/imgs/page/homepage5/activity.png'
                                alt='Travila'
                              />
                            </div>
                        ...
                        <SwiperSlide>
                          <div className='card-popular-destination card-popular-destination-type-2'>
                            <div className='card-image'>
                              {' '}
                              <img
                                src='/assets/imgs/page/homepage5/activity2.png'
                                alt='Travila'
                              />
                            </div>
                            <div className='card-info'>
                        ...
                        <SwiperSlide>
                          <div className='card-popular-destination card-popular-destination-type-2'>
                            <div className='card-image'>
                              {' '}
                              <img
                                src='/assets/imgs/page/homepage5/activity3.png'
                                alt='Travila'
                              />
                            </div>
                            <div className='card-info'>
                        ...
                        <SwiperSlide>
                          <div className='card-popular-destination card-popular-destination-type-2'>
                            <div className='card-image'>
                              {' '}
                              <img
                                src='/assets/imgs/page/homepage5/activity4.png'
                                alt='Travila'
                              />
                            </div>
                            <div className='card-info'>
                        ...
                        <SwiperSlide>
                          <div className='card-popular-destination card-popular-destination-type-2'>
                            <div className='card-image'>
                              {' '}
                              <img
                                src='/assets/imgs/page/homepage5/activity5.png'
                                alt='Travila'
                              />
                            </div>
                            <div className='card-info'>
                        ...
                        <SwiperSlide>
                          <div className='card-popular-destination card-popular-destination-type-2'>
                            <div className='card-image'>
                              {' '}
                              <img
                                src='/assets/imgs/page/homepage5/activity6.png'
                                alt='Travila'
                              />
                            </div>
                            <div className='card-info'>
                        ...
                        <SwiperSlide>
                          <div className='card-popular-destination card-popular-destination-type-2'>
                            <div className='card-image'>
                              {' '}
                              <img
                                src='/assets/imgs/page/homepage5/activity7.png'
                                alt='Travila'
                              />
                            </div>
                            <div className='card-info'>
                        ...
                        <SwiperSlide>
                          <div className='card-popular-destination card-popular-destination-type-2'>
                            <div className='card-image'>
                              {' '}
                              <img
                                src='/assets/imgs/page/homepage5/activity8.png'
                                alt='Travila'
                              />
                            </div>
                            <div className='card-info'>
                  ...
                  <Swiper {...swiperGroupCenter4}>
                    <SwiperSlide>
                      <div className='card-blog'>
                        <div className='card-image'>
                          <img
                            src='/assets/imgs/page/blog/blog.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <SwiperSlide>
                      <div className='card-blog'>
                        <div className='card-image'>
                          <img
                            src='/assets/imgs/page/blog/blog2.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                          <div className='card-info-blog'>
                            ...
                            <Link className='card-title heading-5' href='#'>
                              Savoring Life’s Palette: Art, Food, and Beyond
                            </Link>
                            <div className='card-meta-user'>
                              <div className='box-author-small'>
                    ...
                    <SwiperSlide>
                      <div className='card-blog'>
                        <div className='card-image'>
                          <img
                            src='/assets/imgs/page/blog/blog3.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <SwiperSlide>
                      <div className='card-blog'>
                        <div className='card-image'>
                          <img
                            src='/assets/imgs/page/blog/blog4.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                        ...
                        <div className='card-info'>
                          <div className='card-info-blog'>
                            ...
                            <Link
                              ...
                              href='/blog-detail'
                            >
                              Fashion Forward, Tech Savvy: My Lifestyle Fusion
                            </Link>
                            <div className='card-meta-user'>
                              <div className='box-author-small'>
                                {' '}
            ...
            <div className='container'>
              <div className='box-button-faq wow fadeInRight'>
                ...
                <Link className='btn btn-border-1' href='#'>
                  ...
                  >
                    <path
                      d='M21.3584 8.29719H18.2269V5.1146C18.2269 4.72631 17.9121 4.41151 17.5238 4.41151H16.8207V2.78464C16.8207 1.24917 15.5715 0 14.036 0H8.96399C7.42848 0 6.17931 1.24917 6.17931 2.78464V4.41146H5.47621C5.08792 4.41146 4.77312 4.72626 4.77312 5.11456V8.29714H1.64157C1.25328 8.29714 0.938477 8.61194 0.938477 9.00024V23.2969C0.938477 23.6852 1.25328 24 1.64157 24H21.3584C21.7467 24 22.0615 23.6852 22.0615 23.2969V9.00029C22.0615 8.61199 21.7467 8.29719 21.3584 8.29719ZM7.5855 2.78464C7.5855 2.02454 8.2039 1.40619 8.96399 1.40619H14.036C14.7961 1.40619 15.4145 2.02454 15.4145 2.78464V4.41146H7.5855V2.78464ZM16.8207 5.81765V22.5938H15.3091V19.1664C15.3091 18.7781 14.9943 18.4633 14.606 18.4633H8.39397C8.00567 18.4633 7.69087 18.7781 7.69087 19.1664V22.5938H6.17931V5.81765H16.8207ZM12.2031 19.8695H13.9029V22.5938H12.2031V19.8695ZM10.7969 22.5938H9.09702V19.8695H10.7969V22.5938ZM2.34467 9.70338H4.77312V22.5938H2.34467V9.70338ZM20.6553 22.5938H18.2269V9.70338H20.6553V22.5938Z'
                      fill='#737373'
                    />
                    <path
                      d='M13.9167 16.5074C14.0066 16.9919 14.59 17.2332 14.9962 16.9545C15.487 16.6313 15.374 15.8643 14.8101 15.6974C14.31 15.5393 13.8084 15.9944 13.9167 16.5074Z'
                      fill='#737373'
                    />
                    <path
                      d='M11.0542 16.9132C11.5094 17.2882 12.2037 16.9594 12.2031 16.3699C12.2071 15.845 11.6297 15.4981 11.1686 15.7498C10.731 15.9757 10.6687 16.6065 11.0542 16.9132Z'
                      fill='#737373'
                    />
                    <path
                      d='M7.7047 16.5073C7.80257 17.0229 8.43733 17.2493 8.83997 16.9131C9.37207 16.4677 9.0163 15.6088 8.32483 15.6701C7.92313 15.7008 7.61597 16.1139 7.7047 16.5073Z'
                      fill='#737373'
                    />
                    <path
                      d='M15.2953 13.4197C15.1967 12.9041 14.5631 12.6777 14.16 13.0138C13.7038 13.3866 13.8899 14.1328 14.4684 14.2465C14.9499 14.3507 15.3988 13.9011 15.2953 13.4197Z'
                      fill='#737373'
                    />
                    <path
                      d='M10.8104 13.6949C10.9015 14.1797 11.4833 14.4207 11.8904 14.1421C12.381 13.8156 12.2691 13.0545 11.7042 12.8849C11.2039 12.7269 10.7026 13.1814 10.8104 13.6949Z'
                      fill='#737373'
                    />
                    <path
                      d='M7.70473 13.6949C7.79459 14.1794 8.37792 14.4207 8.78417 14.142C9.27531 13.8161 9.16309 13.0539 8.59809 12.8849C8.0979 12.7268 7.59631 13.1817 7.70473 13.6949Z'
                      fill='#737373'
                    />
                    <path
                      d='M15.3055 10.6759C15.2578 10.1532 14.6502 9.86548 14.2157 10.1603C13.7251 10.4833 13.8378 11.251 14.4019 11.4174C14.8712 11.5682 15.3607 11.165 15.3055 10.6759Z'
                      fill='#737373'
                    />
                    <path
                      d='M10.8105 10.8828C10.9014 11.3678 11.4834 11.6086 11.8905 11.33C12.3812 11.0037 12.269 10.2419 11.7039 10.0729C11.2037 9.91483 10.7028 10.3699 10.8105 10.8828Z'
                      fill='#737373'
                    />
                    <path
                      d='M7.70474 10.8829C7.79459 11.3675 8.37793 11.6088 8.78418 11.33C9.27513 11.0043 9.16291 10.242 8.59809 10.0729C8.09805 9.91476 7.59627 10.3699 7.70474 10.8829Z'
                      fill='#737373'
                    />
                    <path
                      d='M13.9167 8.07034C14.0065 8.55496 14.5901 8.79594 14.9962 8.51751C15.4868 8.19418 15.374 7.42724 14.8101 7.26037C14.31 7.10236 13.8084 7.55727 13.9167 8.07034Z'
                      fill='#737373'
                    />
                    <path
                      d='M10.8105 8.07036C10.9012 8.5547 11.4835 8.79623 11.8899 8.51753C12.3814 8.19213 12.2691 7.42993 11.7043 7.26039C11.2038 7.10238 10.703 7.55691 10.8105 8.07036Z'
                      fill='#737373'
                    />
                    <path
                      d='M7.70475 8.07034C7.79461 8.555 8.37794 8.79593 8.78419 8.51751C9.27505 8.19446 9.16213 7.42714 8.59811 7.26037C8.09764 7.10241 7.5968 7.55703 7.70475 8.07034Z'
                      fill='#737373'
                    />
                  </svg>
                  Hotels Booking
                ...
                <Link className='btn btn-border-1' href='#'>
                  ...
                  >
                    <path
                      d='M17.6719 11.0625V0.703125C17.6719 0.314812 17.3571 0 16.9688 0H1.03125C0.642937 0 0.328125 0.314812 0.328125 0.703125V11.0625C0.328125 11.249 0.402234 11.4278 0.534094 11.5597L0.974391 12L0.534094 12.4403C0.402234 12.5722 0.328125 12.751 0.328125 12.9375V23.2969C0.328125 23.6852 0.642937 24 1.03125 24H16.9688C17.3571 24 17.6719 23.6852 17.6719 23.2969V12.9375C17.6719 12.751 17.5978 12.5722 17.4659 12.4403L17.0256 12L17.466 11.5597C17.5978 11.4278 17.6719 11.249 17.6719 11.0625ZM16.2656 10.7713L15.5341 11.5028C15.2595 11.7774 15.2595 12.2226 15.5341 12.4972L16.2656 13.2287V22.5938H1.73438V13.2287L2.46591 12.4972C2.7405 12.2226 2.7405 11.7774 2.46591 11.5028L1.73438 10.7713V1.40625H16.2656V10.7713Z'
                      fill='#737373'
                    />
                    <path
                      d='M4.32536 7.58274L5.43443 8.56618C5.66088 8.76699 5.99041 8.80032 6.25249 8.64901L9.58015 6.72779L9.44716 8.78991C9.42218 9.17743 9.71608 9.51183 10.1036 9.53687C10.4911 9.5619 10.8255 9.26794 10.8506 8.88043L11.0439 5.88277L13.5596 4.4303C13.8959 4.23615 14.0111 3.80612 13.8169 3.46983C13.6227 3.13351 13.1928 3.01833 12.8565 3.21249L10.3407 4.66496L7.64801 3.33357C7.29986 3.16149 6.87822 3.30413 6.70605 3.65222C6.53393 4.00032 6.67661 4.42205 7.02471 4.59418L8.87702 5.51007L5.98825 7.17788L5.25836 6.53063C4.96783 6.27305 4.52346 6.29968 4.26579 6.59021C4.00816 6.88069 4.03483 7.32507 4.32536 7.58274Z'
                      fill='#737373'
                    />
                    <path
                      d='M3.84375 15.5625H14.1562C14.5446 15.5625 14.8594 15.2477 14.8594 14.8594C14.8594 14.4711 14.5446 14.1562 14.1562 14.1562H3.84375C3.45544 14.1562 3.14062 14.4711 3.14062 14.8594C3.14062 15.2477 3.45544 15.5625 3.84375 15.5625Z'
                      fill='#737373'
                    />
                    <path
                      d='M3.84375 18.375H9C9.38831 18.375 9.70312 18.0602 9.70312 17.6719C9.70312 17.2836 9.38831 16.9688 9 16.9688H3.84375C3.45544 16.9688 3.14062 17.2836 3.14062 17.6719C3.14062 18.0602 3.45544 18.375 3.84375 18.375Z'
                      fill='#737373'
                    />
                    <path
                      d='M3.84375 21.1875H9C9.38831 21.1875 9.70312 20.8727 9.70312 20.4844C9.70312 20.0961 9.38831 19.7812 9 19.7812H3.84375C3.45544 19.7812 3.14062 20.0961 3.14062 20.4844C3.14062 20.8727 3.45544 21.1875 3.84375 21.1875Z'
                      fill='#737373'
                    />
                    <path
                      d='M4.78125 12.7031H5.71875C6.10706 12.7031 6.42188 12.3883 6.42188 12C6.42188 11.6117 6.10706 11.2969 5.71875 11.2969H4.78125C4.39294 11.2969 4.07812 11.6117 4.07812 12C4.07812 12.3883 4.39294 12.7031 4.78125 12.7031Z'
                      fill='#737373'
                    />
                    <path
                      d='M9.46875 11.2969H8.53125C8.14294 11.2969 7.82812 11.6117 7.82812 12C7.82812 12.3883 8.14294 12.7031 8.53125 12.7031H9.46875C9.85706 12.7031 10.1719 12.3883 10.1719 12C10.1719 11.6117 9.85706 11.2969 9.46875 11.2969Z'
                      fill='#737373'
                    />
                    <path
                      d='M13.2188 11.2969H12.2812C11.8929 11.2969 11.5781 11.6117 11.5781 12C11.5781 12.3883 11.8929 12.7031 12.2812 12.7031H13.2188C13.6071 12.7031 13.9219 12.3883 13.9219 12C13.9219 11.6117 13.6071 11.2969 13.2188 11.2969Z'
                      fill='#737373'
                    />
                    <path
                      d='M12.75 16.9688C11.5869 16.9688 10.6406 17.915 10.6406 19.0781C10.6406 20.2412 11.5869 21.1875 12.75 21.1875C13.9131 21.1875 14.8594 20.2412 14.8594 19.0781C14.8594 17.915 13.9131 16.9688 12.75 16.9688ZM12.75 19.7812C12.3623 19.7812 12.0469 19.4658 12.0469 19.0781C12.0469 18.6904 12.3623 18.375 12.75 18.375C13.1377 18.375 13.4531 18.6904 13.4531 19.0781C13.4531 19.4658 13.1377 19.7812 12.75 19.7812Z'
                      fill='#737373'
                    />
                  </svg>
                  Tickets Booking
                  ...
                  <div className='box-grid-hotels box-grid-news mt-60 mb-50 wow fadeIn'>
                    <div className='card-flight card-news background-card'>
                      <div className='card-image'>
                        ...
                        <Link href='/blog-detail'>
                          <img
                            src='/assets/imgs/page/blog/news.png'
                            alt='Travila'
                          />
                        </Link>
                      </div>
                      <div className='card-info'>
                        ...
                        <div className='card-title'>
                          ...
                          <Link
                            ...
                            href='/blog-detail'
                          >
                            The Art of Living: A Stylish Tech Odyssey
                          </Link>
                        </div>
                    ...
                    <div className='card-flight card-news background-card'>
                      <div className='card-image'>
                        ...
                        <Link href='/blog-detail'>
                          <img
                            src='/assets/imgs/page/blog/news2.png'
                            alt='Travila'
                          />
                        </Link>
                      </div>
                      <div className='card-info'>
                        ...
                        <div className='card-title'>
                          ...
                          <Link
                            ...
                            href='/blog-detail'
                          >
                            Brushstrokes of Life: A Creative Journey Unveiled
                          </Link>
                        </div>
                        <div className='card-meta'>
                          {' '}
                    ...
                    <div className='card-flight card-news background-card'>
                      <div className='card-image'>
                        ...
                        <Link href='/blog-detail'>
                          <img
                            src='/assets/imgs/page/blog/news3.png'
                            alt='Travila'
                          />
                        </Link>
                      </div>
                    ...
                    <div className='card-flight card-news background-card'>
                      <div className='card-image'>
                        ...
                        <Link href='/blog-detail'>
                          <img
                            src='/assets/imgs/page/blog/news4.png'
                            alt='Travila'
                          />
                        </Link>
                      </div>
                      <div className='card-info'>
                        ...
                        <div className='card-title'>
                          ...
                          <Link
                            ...
                            href='/blog-detail'
                          >
                            Tech Threads and Culinary Canvas: My Lifestyle
                            Palette
                          </Link>
                        </div>
                        <div className='card-meta'>
                        ...
                        <li>
                          <div className='card-post'>
                            <div className='card-image'>
                              ...
                              <Link href='/blog-detail'>
                                <img
                                  src='/assets/imgs/page/blog/trending5.png'
                                  alt='Travila'
                                />
                              </Link>
                            </div>
            ...
            <div className='container'>
              <div className='block-subscriber'>
                <div className='subscriber-left'>
                  ...
                  <p className='text-sm-medium neutral-500 mt-15'>
