                ...
                <div className='col-lg-6 mb-30'>
                  <div className='box-right-payment'>
                    ...
                    <p className='text-lg-medium neutral-500 mb-35'>
                      ...
                      of Paris, France, renowned for its elegance,
                      sophistication, and rich history. Nestled on the Rue de
                      Rivoli, overlooking the splendid Tuileries Garden and just
                      steps away from the Louvre Museum, this esteemed
                      establishment has been a beacon of opulence and
