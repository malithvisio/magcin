              ...
              <div className='container-banner-activities'>
                <div className='box-banner-activities'>
                  ...
                  >
                    <div className='banner-slide-activity'>
                      <img
                        src='/assets/imgs/page/activities/banner.png'
                        alt='Travila'
                      />
                    </div>
                    <div className='banner-slide-activity'>
                ...
                <div className='slider-thumnail-activities'>
                  ...
                  >
                    ...
                    <div className='banner-slide'>
                      <img
                        src='/assets/imgs/page/homepage2/thumb2.png'
                        alt='Travila'
                      />
                    </div>
                    <div className='banner-slide'>
                      <img
                        src='/assets/imgs/page/homepage2/thumb3.png'
                        alt='Travila'
                      />
                    </div>
                    <div className='banner-slide'>
                  ...
                  <div className='col-lg-8'>
                    <div className='tour-title-main'>
                      <h4 className='neutral-1000'>
                        Peak Pursuits: Adventuring Through Discovery Mountain's
                        Hidden Gems
                      </h4>
                    </div>
                  </div>
