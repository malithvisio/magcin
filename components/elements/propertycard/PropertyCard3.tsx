      ...
      <div className='card-flight card-hotel card-property background-card'>
        <div className='card-image'>
          ...
          <Link href='/property-detail'>
            <img
              src={`/assets/imgs/page/homepage9/${property.image}`}
              alt='Travila'
            />
          </Link>
        </div>
        <div className='card-info'>
          ...
          <div className='card-title'>
            {' '}
            <Link className='heading-6 neutral-1000' href='/property-detail'>
              {property.name}
            </Link>
          </div>
          <div className='card-program'>
            <div className='card-location mb-25'>
              <p className='text-location text-md-medium neutral-500'>
                Suite 756 031 Ines Riverway, Rhiannonchester
              </p>
            </div>
            <div className='card-facilities'>
              ...
              <div className='item-facilities'>
                <p className='parking text-md-medium neutral-1000'>
                  Free parking
                </p>
              </div>
              <div className='item-facilities'>
            ...
            <div className='endtime'>
              ...
              <div className='card-button'>
                {' '}
                <Link className='btn btn-gray' href='/property-detail'>
                  Book Now
                </Link>
              </div>
            </div>
