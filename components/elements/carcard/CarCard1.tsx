      ...
      <div className='card-journey-small card-grid-car background-card'>
        <div className='card-image'>
          ...
          <Link href='/rental-detail'>
            <img src={`/assets/imgs/page/car/${car.image}`} alt='Travila' />
          </Link>
        </div>
        <div className='card-info'>
          ...
          <div className='card-title'>
            {' '}
            <Link className='text-lg-bold neutral-1000' href='/rental-detail'>
              {car.name}{' '}
            </Link>
          </div>
          <div className='card-program'>
            ...
            <div className='endtime'>
              ...
              <div className='card-button'>
                {' '}
                <Link className='btn btn-gray' href='/rental-detail'>
                  Book Now
                </Link>
              </div>
            </div>
