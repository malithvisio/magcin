                    ...
                    <div className='card-spot background-card wow fadeInDown'>
                      <div className='card-image'>
                        ...
                        <Link href='/rental-property-2'>
                          <img
                            src='/assets/imgs/page/homepage9/area.png'
                            alt='Travila'
                          />
                        </Link>
                      </div>
                  ...
                  <SwiperSlide>
                    <div className='card-spot background-card wow fadeInDown'>
                      <div className='card-image'>
                        ...
                        <Link href='/rental-property-2'>
                          <img
                            src='/assets/imgs/page/homepage9/area2.png'
                            alt='Travila'
                          />
                        </Link>
                      </div>
                  ...
                  <SwiperSlide>
                    <div className='card-spot background-card wow fadeInDown'>
                      <div className='card-image'>
                        ...
                        <Link href='/rental-property-2'>
                          <img
                            src='/assets/imgs/page/homepage9/area3.png'
                            alt='Travila'
                          />
                        </Link>
                      </div>
                  ...
                  <SwiperSlide>
                    <div className='card-spot background-card wow fadeInDown'>
                      <div className='card-image'>
                        ...
                        <Link href='/rental-property-2'>
                          <img
                            src='/assets/imgs/page/homepage9/area4.png'
                            alt='Travila'
                          />
                        </Link>
                      </div>
