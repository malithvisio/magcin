                ...
                <SwiperSlide>
                  <div className='card-journey-small background-card'>
                    <div className='card-image'>
                      ...
                      <img
                        src='/assets/imgs/page/homepage2/car.png'
                        alt='Travila'
                      />
                    </div>
                ...
                <SwiperSlide>
                  <div className='card-journey-small background-card'>
                    <div className='card-image'>
                      ...
                      <img
                        src='/assets/imgs/page/homepage2/car2.png'
                        alt='Travila'
                      />
                    </div>
                    <div className='card-info'>
                ...
                <SwiperSlide>
                  <div className='card-journey-small background-card'>
                    <div className='card-image'>
                      ...
                      <img
                        src='/assets/imgs/page/homepage2/car3.png'
                        alt='Travila'
                      />
                    </div>
                    <div className='card-info'>
                ...
                <SwiperSlide>
                  <div className='card-journey-small background-card'>
                    <div className='card-image'>
                      ...
                      <img
                        src='/assets/imgs/page/homepage2/car4.png'
                        alt='Travila'
                      />
                    </div>
                    <div className='card-info'>
