      ...
      <section className='section-box box-featured-propoerties background-body'>
        <div className='container'>
                    ...
                    <div className='col-lg-4 col-md-6 wow fadeInUp'>
                      <div className='card-journey-small card-grid-real background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage9/real1.png'
                            alt='Travila'
                          />
                        </div>
                          ...
                          <div className='card-program'>
                            ...
                            <div className='endtime'>
                              <div className='card-price'>
                                <p className='text-md-medium neutral-500 mr-10'>
                                  from{' '}
                                </p>
                    ...
                    <div className='col-lg-4 col-md-6 wow fadeInUp'>
                      <div className='card-journey-small card-grid-real background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage9/real2.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <div className='col-lg-4 col-md-6 wow fadeInUp'>
                      <div className='card-journey-small card-grid-real background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage9/real3.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <div className='col-lg-4 col-md-6 wow fadeInUp'>
                      <div className='card-journey-small card-grid-real background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage9/real4.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <div className='col-lg-4 col-md-6 wow fadeInUp'>
                      <div className='card-journey-small card-grid-real background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage9/real5.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <div className='col-lg-4 col-md-6 wow fadeInUp'>
                      <div className='card-journey-small card-grid-real background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage9/real6.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
          ...
          <div className='d-flex justify-content-center'>
            <Link className='btn btn-black-lg' href='/rental-property'>
              <svg
                className='first'
                width={25}
                height={24}
