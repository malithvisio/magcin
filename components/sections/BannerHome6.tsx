          ...
          <div className='box-swiper'>
            <div className='swiper-container swiper-group-1'>
              <Swiper {...swiperGroup1}>
                <SwiperSlide>
                  <div
                    className='item-banner-slide'
                    style={{
                      backgroundImage:
                        'url(assets/imgs/page/homepage7/banner.png)',
                    }}
                  >
                    <div className='container'>
                      {' '}
                      <span className='btn btn-brand-secondary wow fadeInUp'>
                        ...
                        <img
                          className='mr-10'
                          src='/assets/imgs/page/homepage7/hotel.svg'
                          alt='Travile'
                        />
                        Great Hotel System
                      </span>
                ...
                <SwiperSlide>
                  <div
                    ...
                    style={{
                      backgroundImage:
                        'url(assets/imgs/page/homepage7/banner-2.png)',
                    }}
                  >
                    <div className='container'>
                      {' '}
                      ...
                      <h5 className='color-white'>
                        Book now your next stay and get special price
                      </h5>
                    </div>
                  </div>
                </SwiperSlide>
