    ...
    <>
      <section className='section-box block-why-choose-us background-body'>
        <div className='container'>
          <div className='bg-why shape-1 wow fadeInUp'>
            {' '}
            <img
              className='light-mode'
              src='/assets/imgs/page/homepage9/bg-dot.png'
              alt='Travila'
            />
            <img
              className='dark-mode'
              src='/assets/imgs/page/homepage9/bg-dot-dark.png'
              alt='Travila'
            />
          </div>
          <div className='bg-why-2 shape-2 wow fadeInUp'>
            <img
              className='light-mode'
              src='/assets/imgs/page/homepage9/bg-dot-2.png'
              alt='Travila'
            />
            <img
              className='dark-mode'
              src='/assets/imgs/page/homepage9/bg-dot-2-dark.png'
              alt='Travila'
            />
          </div>
          <div className='box-why-home9-inner background-card'>
            <div className='box-why-home9-inner-inner'>
              <h3 className='neutral-1000 mb-15 wow fadeInUp'>
                Why Choose Us?
              </h3>
              <p className='text-xl-medium neutral-500 mb-45 wow fadeInUp'>
              ...
              <div className='box-list-why wow fadeInUp'>
                <div className='card-why-travel card-love-us wow fadeInUp'>
                  ...
                  <div className='card-info'>
                    {' '}
                    <Link
                      className='text-xl-bold card-title'
                      href='/help-center'
                    >
                      24/7 Support
                    </Link>
