    ...
    <>
      <section className='box-section block-banner-9 box-banner-home5-search background-body'>
        <div className='block-banner-9-inner'>
            ...
            <div className='row'>
              <div className='col-lg-6 wow fadeInUp'>
                ...
                <h1 className='neutral-1000 mt-15 mb-15'>
                  {' '}
                  <span>Discover a </span>Place <span>You’ll </span>Love
                  <span>To Live</span>
                </h1>
          ...
          <div className='image-banner-bottom'>
            {' '}
            <img
              src='/assets/imgs/page/homepage9/banner-sm.png'
              alt='Travila'
            />
          </div>
          <div className='image-banner-top-left'>
            {' '}
            <img
              src='/assets/imgs/page/homepage9/banner-sm2.png'
              alt='Travila'
            />
          </div>
          <div
            className='block-right-banner'
            style={{
              backgroundImage: 'url(assets/imgs/page/homepage9/banner.png)',
            }}
          >
            <div className='item-support border-1 background-body'>
              {' '}
              <img
                className='light-mode'
                src='/assets/imgs/page/homepage9/support.png'
                alt='Travila'
              />
              <img
                className='dark-mode'
                src='/assets/imgs/page/homepage9/support-dark.png'
                alt='Travila'
              />
              ...
              <div className='box-authors-partner background-body wow fadeInUp'>
                ...
                <div className='authors-partner-right'>
                  <p className='text-sm neutral-1000'>
                    1684 people used <strong>Travila </strong>in the last
