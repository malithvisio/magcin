...
export default function TopRated43() {
  return (
    <>
      <section className='section-box box-top-rated-3 box-nearby background-body'>
        <div className='container'>
          <h2 className='neutral-1000 wow fadeInUp'>Popular Nearby</h2>
          ...
          <div className='box-button-tabs wow fadeInUp'>
            {' '}
            <Link className='btn btn-white' href='/activities'>
              All
            </Link>
            <Link className='btn btn-white' href='/activities'>
              Luxury
