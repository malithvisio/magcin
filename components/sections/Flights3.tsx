                    ...
                    <div className='col-lg-4 col-md-6 wow fadeInUp'>
                      <div className='card-journey-small card-grid-car background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage8/car1.png'
                            alt='Travila'
                          />
                        </div>
                          ...
                          <div className='card-program'>
                            ...
                            <div className='card-facilities'>
                              <div className='item-facilities'>
                                <p className='speed text-md-medium neutral-1000'>
                                  25,100 miles
                                </p>
                              </div>
                              <div className='item-facilities'>
                                <p className='gear text-md-medium neutral-1000'>
                                  Automatic
                                </p>
                              </div>
                              <div className='item-facilities'>
                                <p className='fuel text-md-medium neutral-1000'>
                                  Diesel
                                </p>
                              </div>
                              <div className='item-facilities'>
                                <p className='seats text-md-medium neutral-1000'>
                                  7 seats
                                </p>
                              </div>
                            </div>
                    ...
                    <div className='col-lg-4 col-md-6 wow fadeInUp'>
                      <div className='card-journey-small card-grid-car background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage8/car2.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <div className='col-lg-4 col-md-6 wow fadeInUp'>
                      <div className='card-journey-small card-grid-car background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage8/car3.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <div className='col-lg-4 col-md-6 wow fadeInUp'>
                      <div className='card-journey-small card-grid-car background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage8/car4.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <div className='col-lg-4 col-md-6 wow fadeInUp'>
                      <div className='card-journey-small card-grid-car background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage8/car5.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <div className='col-lg-4 col-md-6 wow fadeInUp'>
                      <div className='card-journey-small card-grid-car background-card'>
                        <div className='card-image'>
                          ...
                          <img
                            src='/assets/imgs/page/homepage8/car6.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                      ...
                      <div className='card-journey-small card-grid-car background-card'>
                        ...
                        <div className='card-info'>
                          ...
                          <div className='card-program'>
                            ...
                            <div className='card-facilities'>
                              <div className='item-facilities'>
                                <p className='speed text-md-medium'>
                                  25,100 miles
                                </p>
                              </div>
                              <div className='item-facilities'>
