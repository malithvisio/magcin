                  ...
                  <SwiperSlide>
                    <div className='card-flight card-hotel background-card'>
                      <div className='card-image'>
                        ...
                        <img
                          src='/assets/imgs/page/homepage7/img-hotel.png'
                          alt='Travila'
                        />
                      </div>
                    ...
                    <div className='card-flight card-hotel background-card'>
                      <div className='card-image'>
                        ...
                        <img
                          src='/assets/imgs/page/homepage7/img-hotel3.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                        <label className='sale-lbl'>-27%</label>
                        <Link
                  ...
                  <SwiperSlide>
                    <div className='card-flight card-hotel background-card'>
                      <div className='card-image'>
                        ...
                        <img
                          src='/assets/imgs/page/homepage7/img-hotel2.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                        <label className='sale-lbl'>-28%</label>
                        <Link
                    ...
                    <div className='card-flight card-hotel background-card'>
                      <div className='card-image'>
                        ...
                        <img
                          src='/assets/imgs/page/homepage7/img-hotel4.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                        <label className='sale-lbl'>-35%</label>
                        <Link
                          className='btn btn-label-tag background-9'
                          href='#'
                        >
                          Standard{' '}
                        </Link>
