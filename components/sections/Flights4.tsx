                  ...
                  <SwiperSlide>
                    <div className='card-flight background-card'>
                      <div className='card-image'>
                        ...
                        <img
                          src='/assets/imgs/page/homepage1/flight.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                        ...
                        <div className='card-date'>
                          <span className='date-1'>09 Jun 2024</span>
                          <span className='line' />
                          <span className='date-1'>16 Jun 2024</span>
                        </div>
                        <div className='card-route'>
                          <h6 className='route-name neutral-1000'>Denmark</h6>
                    ...
                    <div className='card-flight background-card'>
                      <div className='card-image'>
                        ...
                        <img
                          src='/assets/imgs/page/homepage1/flight4.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <SwiperSlide>
                    ...
                    <div className='card-flight background-card'>
                      <div className='card-image'>
                        ...
                        <img
                          src='/assets/imgs/page/homepage1/flight5.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                  ...
                  <SwiperSlide>
                    <div className='card-flight background-card'>
                      <div className='card-image'>
                        ...
                        <img
                          src='/assets/imgs/page/homepage1/flight3.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
                    ...
                    <div className='card-flight background-card'>
                      <div className='card-image'>
                        ...
                        <img
                          src='/assets/imgs/page/homepage1/flight6.png'
                          alt='Travila'
                        />
                      </div>
                      <div className='card-info'>
