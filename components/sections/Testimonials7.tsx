      ...
      <section className='section-box box-testimonials-2 box-testimonials-6 background-body'>
        <div className='container'>
          ...
          <div className='box-img-test-1'>
            {' '}
            <img
              src='/assets/imgs/page/homepage10/img-test.png'
              alt='Travila'
            />
          </div>
          <div className='box-img-test-2'>
            <img
              src='/assets/imgs/page/homepage10/img-test2.png'
              alt='Travila'
            />
          </div>
          <div className='box-img-test-3'>
            {' '}
            <img
              src='/assets/imgs/page/homepage10/img-test3.png'
              alt='Travila'
            />
          </div>
          <div className='box-img-test-4'>
            {' '}
            <img
              src='/assets/imgs/page/homepage10/img-test4.png'
              alt='Travila'
            />
          </div>
                  ...
                  <Swiper {...swiperGroup1}>
                    <SwiperSlide>
                      <div className='card-testimonial card-testimonial-2'>
                        ...
                        <div className='card-info'>
                          <p className='neutral-1000 text-md'>
