          ...
          <div className='row mt-35'>
                ...
                <div className='item-flight background-card border-1'>
                  <div className='flight-route'>
                    <div className='flight-name'>
                      {' '}
                      <img
                        src='/assets/imgs/page/homepage10/logo1.png'
                        alt='Travila'
                      />
                      <div className='flight-info'>
                        ...
                        <p className='text-sm-medium time-flight'>
                          {' '}
                          <span className='neutral-1000'>20:00</span>- 05 Jan
                          2024
                        </p>
                      </div>
                    </div>
                  ...
                  <div className='flight-button'>
                    {' '}
                    <Link className='btn btn-gray' href='/book-ticket'>
                      Book Now
                    </Link>
                  </div>
                </div>
                <div className='item-flight background-card border-1'>
                  <div className='flight-route'>
                    <div className='flight-name'>
                      {' '}
                      <img
                        src='/assets/imgs/page/homepage10/tokyo.png'
                        alt='Travila'
                      />
                      <div className='flight-info'>
                ...
                <div className='item-flight background-card border-1'>
                  <div className='flight-route'>
                    <div className='flight-name'>
                      {' '}
                      <img
                        src='/assets/imgs/page/homepage10/sydney.png'
                        alt='Travila'
                      />
                      <div className='flight-info'>
                        <p className='text-md-bold neutral-1000'>
                ...
                <div className='item-flight background-card border-1'>
                  <div className='flight-route'>
                    <div className='flight-name'>
                      {' '}
                      <img
                        src='/assets/imgs/page/homepage10/dubai.png'
                        alt='Travila'
                      />
                      <div className='flight-info'>
                ...
                <div className='item-flight background-card border-1'>
                  <div className='flight-route'>
                    <div className='flight-name'>
                      {' '}
                      <img
                        src='/assets/imgs/page/homepage10/los.png'
                        alt='Travila'
                      />
                      <div className='flight-info'>
                        <p className='text-md-bold neutral-1000'>
                ...
                <div className='item-flight background-card border-1'>
                  <div className='flight-route'>
                    <div className='flight-name'>
                      {' '}
                      <img
                        src='/assets/imgs/page/homepage10/paris.png'
                        alt='Travila'
                      />
                      <div className='flight-info'>
                    ...
                    <div className='flight-name'>
                      <div className='flight-info'>
                        ...
                        <p className='text-sm-medium time-flight'>
                          {' '}
                          <span className='neutral-1000'>14:00</span>- 06 Jan
                          2024
                        </p>
                      </div>
                    </div>
            ...
            <div className='col-lg-3'>
              <div className='sidebar-area border-1'>
                <h6 className='text-lg-bold neutral-1000 mb-15'>
                  Class / Cabin
                </h6>
                <div className='box-list-tags'>
                  {' '}
                  <Link className='btn btn-tag-sm' href='#'>
                    All Class
                  </Link>
                  <Link className='btn btn-tag-sm' href='#'>
                    Business
