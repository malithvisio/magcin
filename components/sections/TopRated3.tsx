...
export default function TopRated3() {
  return (
    <>
      <section className='section-box box-top-rated-3 background-body'>
        ...
        <div className='container-slider box-swiper-padding wow fadeInUp'>
