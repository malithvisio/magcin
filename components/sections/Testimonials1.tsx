        ...
        <div className='container-testimonials'>
          <div className='block-testimonials'>
            <div className='testimonials-left'>
              ...
              <h2 className='text-52-bold mt-8 mb-25 neutral-1000'>
                    ...
                    <Swiper {...swiperGroupAnimate}>
                      ...
                      <SwiperSlide>
                        <div className='card-testimonial background-card'>
                          ...
                          <div className='card-info'>
                            <p className='neutral-500'>
                              I had a last-minute business trip, and the hotel
                              booking system came to the rescue. I was able to
                              find a high-quality hotel in no time and even got
                              a great deal on the room. The confirmation process
                              was straightforward, and I received all the
