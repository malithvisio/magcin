    ...
    <>
      <section className='section-box box-banner-home4 background-body'>
        <div className='banner-marker wow fadeInUp'>
          {' '}
          <img
            className='mr-10 light-mode'
            src='/assets/imgs/page/homepage4/marker.svg'
            alt='Travile'
          />
          <img
            className='mr-10 dark-mode'
            src='/assets/imgs/page/homepage4/marker.svg'
            alt='Travile'
          />
        </div>
        <div className='banner-plus wow fadeInUp'>
          ...
          <img
            className='mr-10 light-mode'
            src='/assets/imgs/page/homepage4/plus.svg'
            alt='Travile'
          />
          <img
            className='mr-10 dark-mode'
            src='/assets/imgs/page/homepage4/plus-dark.svg'
            alt='Travile'
          />
        </div>
        <div className='banner-fly wow fadeInUp'>
          <img
            className='mr-10 light-mode'
            src='/assets/imgs/page/homepage4/fly.svg'
            alt='Travile'
          />
          <img
            className='mr-10 dark-mode'
            src='/assets/imgs/page/homepage4/fly-dark.svg'
            alt='Travile'
          />
        </div>
        <div className='container'>
          ...
          <div className='box-image-banner-home4'>
            <img src='/assets/imgs/page/homepage4/banner.png' alt='Travila' />
            <div className='shape-rate'>
              {' '}
              <img
                className='light-mode'
                src='/assets/imgs/page/homepage4/review.png'
                alt='Travila'
              />
              <img
                className='dark-mode'
                src='/assets/imgs/page/homepage4/review-dark.png'
                alt='Travila'
              />
            </div>
            <div className='shape-phone'>
              <img
                className='light-mode'
                src='/assets/imgs/page/homepage4/hotline.png'
                alt='Travila'
              />
              <img
                className='dark-mode'
                src='/assets/imgs/page/homepage4/hotline-dark.png'
                alt='Travila'
              />
            </div>
          </div>
