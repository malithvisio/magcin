    ...
    <>
      <section className='section-box block-meet background-body'>
        <div className='container'>
          <div className='row align-items-end'>
            <div className='col-lg-6 mb-30 wow fadeInUp'>
              ...
              <p className='text-xl-medium neutral-500'>
                Meet our exceptional team of agents, each dedicated to making
                your property journey seamless and successful
              </p>
            </div>
            <div className='col-md-6 position-relative mb-30 wow fadeInUp'>
          ...
          <div className='box-swiper mt-35'>
            <div className='swiper-container swiper-group-1 swiper-group-journey'>
              <Swiper {...swiperGroup1}>
                <SwiperSlide>
                  <div className='row'>
                    <div className='col-lg-6 wow fadeInUp'>
                      <div className='card-team'>
                        <div className='card-image'>
                          {' '}
                          <img
                            src='/assets/imgs/page/homepage9/team.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                          ...
                          <p className='text-xs-medium neutral-1000'>
                            ...
                            leads the Travila team with passion and expertise.
                            His commitment to client satisfaction and market
                            knowledge sets the standard for our exceptional
                            service.
                          </p>
                    ...
                    <div className='col-lg-6 wow fadeInUp'>
                      <div className='card-team'>
                        <div className='card-image'>
                          {' '}
                          <img
                            src='/assets/imgs/page/homepage9/team2.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                          ...
                          <p className='text-xs-medium neutral-1000'>
                            Known for her outstanding negotiation skills and
                            keen market insight, Emily is your go-to expert for
                            buying or selling your property. Her dedication
                            ensures a smooth and stress-free experience for all
                            clients
                          </p>
                          <div className='card-socials'>
                            {' '}
                    ...
                    <div className='col-lg-6 wow fadeInUp'>
                      <div className='card-team'>
                        <div className='card-image'>
                          {' '}
                          <img
                            src='/assets/imgs/page/homepage9/team3.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
                    ...
                    <div className='col-lg-6 wow fadeInUp'>
                      <div className='card-team'>
                        <div className='card-image'>
                          {' '}
                          <img
                            src='/assets/imgs/page/homepage9/team4.png'
                            alt='Travila'
                          />
                        </div>
                        <div className='card-info'>
