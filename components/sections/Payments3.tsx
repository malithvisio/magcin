            ...
            <div className='col-lg-5 mb-30 text-center text-lg-end wow fadeInUp'>
              <div className='box-video-payment'>
                <div className='dot-payment'>
                  {' '}
                  <img
                    src='/assets/imgs/page/homepage4/dot-payment.png'
                    alt='Travila'
                  />
                </div>
                <div className='img-sm-payment'>
                  {' '}
                  <img
                    src='/assets/imgs/page/homepage4/img-payment-sm.png'
                    alt='Travila'
                  />
                </div>
                <div className='review-payment'>
                  ...
                  <img
                    ...
                    src='/assets/imgs/page/homepage4/img-review.png'
                    alt='Travila'
                  />
                  <img
                    className='dark-mode'
                    src='/assets/imgs/page/homepage4/img-review-dark.png'
                    alt='Travila'
                  />
                </div>
                <div className='card-video'>
                  <div className='card-image'>
                    ...
                    <img
                      src='/assets/imgs/page/homepage4/img-payment.png'
                      alt='Travila'
                    />
                  </div>
                </div>
