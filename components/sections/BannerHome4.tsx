            ...
            <div className='block-banner-home5'>
              <div className='row align-items-center'>
                <div className='col-xl-6 col-lg-7 wow fadeInUp'>
                  <h1 className='mt-20 mb-35 neutral-1000'>
                    {' '}
                    <span>Begin Your </span>
                    <br className='d-none d-lg-block' />
                    Fantastic Travel Experience <span>Here</span>
                  </h1>
                  ...
                  <div className='box-buttons-banner'>
                    {' '}
                    <Link className='btn btn-brand-secondary' href='#'>
                      Discover Now
                    </Link>
                    <VideoPopup
                      vdocls='btn btn-how-work popup-youtube'
                      style3
                    />
                  </div>
                </div>
              </div>
              <div className='box-image-banner-home5 wow fadeInUp'>
                <img
