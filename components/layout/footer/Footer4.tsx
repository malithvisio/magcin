            ...
            <div className='col-lg-3 mt-30'>
              ...
              <div className='d-flex align-items-center'>
                <form className='form-newsletter form-newsletter-2' action='#'>
                  ...
                  />
                  <input
                    className='btn btn-brand-secondary w-100 justify-content-center'
                    type='submit'
          ...
          <div className='box-footer-col-3'>
            <div className='footer-col-1'>
              <div className='box-footer-help'>
                <img alt='Travila' src='/assets/imgs/page/homepage6/help.svg' />
                <div className='box-info-support'>
                  <p className='text-md-medium mb-5'>Need help? Call us</p>
                  <Link
            ...
            <div className='footer-col-2'>
              <div className='box-join'>
                <img alt='Travila' src='/assets/imgs/page/homepage6/join.svg' />
            ...
            <div className='footer-col-3'>
              <div className='box-send-message'>
                {' '}
                <img alt='Travila' src='/assets/imgs/page/homepage6/msg.svg' />
            ...
            <div className='row align-items-center'>
              <div className='col-md-6 text-md-start text-center mb-20'>
                <p className='text-sm color-white'>
                  © {new Date().getFullYear()} Travila Inc. All rights
                  reserved.
                </p>
              </div>
              <div className='col-md-6 text-md-end text-center mb-20'>
                <div className='d-flex align-items-center justify-content-center justify-content-md-end box-socials-footer-cover'>
                  <p className='text-lg-bold color-white d-inline-block mr-10'>
                    Follow us
                  </p>
