    ...
    <>
      <header className={`header sticky-bar ${scroll ? 'stick' : ''}`}>
        <div
          ...
          style={{
            background:
              'linear-gradient(90deg,rgb(218, 105, 13) 0%,rgb(6, 64, 189) 100%)',
          }}
        >
          <div className='container-fluid'>
            <div className='text-header'>
              <div className='text-unlock text-sm-bold'>
                Explore Sri Lanka with Magcin Tours – Authentic Journeys, Hidden
                Treasures & Lasting Memories!
              </div>
        ...
        <style jsx>{`
          ...
          /* Mobile menu button positioning improvements */
