        ...
        <SwiperSlide>
          <div className='card-news background-card hover-up'>
            <div className='card-image'>
              ...
              <img src='/assets/imgs/page/homepage1/news.png' alt='Travila' />
            </div>
            <div className='card-info'>
              ...
              <div className='card-title'>
                {' '}
                <Link className='text-xl-bold neutral-1000' href='/blog-detail'>
              ...
              <div className='card-program'>
                <div className='endtime'>
                  ...
                  <div className='card-button'>
                    {' '}
                    <Link className='btn btn-gray' href='/blog-detail'>
                      Keep Reading
                    </Link>
                  </div>
                </div>
        ...
        <SwiperSlide>
          <div className='card-news background-card hover-up'>
            <div className='card-image'>
              ...
              <img src='/assets/imgs/page/homepage1/news2.png' alt='Travila' />
            </div>
            <div className='card-info'>
              <div className='card-meta'>
                {' '}
        ...
        <SwiperSlide>
          <div className='card-news background-card hover-up'>
            <div className='card-image'>
              ...
              <img src='/assets/imgs/page/homepage1/news3.png' alt='Travila' />
            </div>
            <div className='card-info'>
              <div className='card-meta'>
                {' '}
